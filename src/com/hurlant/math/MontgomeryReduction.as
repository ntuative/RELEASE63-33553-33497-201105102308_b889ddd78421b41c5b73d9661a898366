package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2035 = param1.invDigit();
         this.var_2034 = this.var_2035 & 32767;
         this.var_2821 = this.var_2035 >> 15;
         this.var_2820 = 131071;
         this.var_2819 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_179) > 0)
         {
