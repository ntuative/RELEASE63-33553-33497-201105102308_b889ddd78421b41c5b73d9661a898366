package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1702 || param1.getUpdateID() != this.var_2373)
         {
            this.var_2373 = param1.getUpdateID();
            if(param2.updateId != this.var_1702 || _loc4_.x != this.var_1146.x || _loc4_.y != this.var_1146.y || _loc4_.z != this.var_1146.z)
            {
               this.var_1702 = param2.updateId;
               this.var_1146.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2374 = _loc3_;
         if(_loc3_)
         {
