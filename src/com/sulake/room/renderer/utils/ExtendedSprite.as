package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1907 || param2 != this.var_1908)
         {
      ...
      {
         if(this.var_1515 > 255 || bitmapData == null)
         {
            return false;
         }
