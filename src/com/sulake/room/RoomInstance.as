   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_282 != null)
         {
            ...
            {
               _loc3_ = this.var_282.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1390.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1390.push(param1);
         }
         if(this.var_589[param1] != param2)
         {
            this.var_589[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_639.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_639[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_282.getValue(_loc2_) != null)
         {
            return this.var_282.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_282.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_282.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_282.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_282.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
