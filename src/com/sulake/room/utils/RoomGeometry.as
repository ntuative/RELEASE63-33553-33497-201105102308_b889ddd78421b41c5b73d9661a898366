package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_767:Number = 64;
      
      public static const const_1206:Number = 32;
      ...
      private var var_2949:Number = -500.0;
      
      private var var_2950:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1281 = new Vector3d();
         this.var_1975 = 1;
         this.var_1974 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1976 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_460.assign(this.var_91);
         this.var_460.x *= this.var_456;
         this.var_460.y *= this.var_459;
         this.var_460.z *= this.var_457;
         return this.var_460;
      }
      ...
      {
         if(this.var_456 != param1 * this.var_1975)
         {
            this.var_456 = param1 * this.var_1975;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_459 != param1 * this.var_1974)
         {
            this.var_459 = param1 * this.var_1974;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_457 != param1 * this.var_1976)
         {
            this.var_457 = param1 * this.var_1976;
            ++this.var_168;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_91.x;
         var _loc3_:Number = this.var_91.y;
         var _loc4_:Number = this.var_91.z;
         this.var_91.assign(param1);
         this.var_91.x /= this.var_456;
         this.var_91.y /= this.var_459;
         this.var_91.z /= this.var_457;
         if(this.var_91.x != _loc2_ || this.var_91.y != _loc3_ || this.var_91.z != _loc4_)
         {
            ++this.var_168;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1282.assign(this.var_158);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_533 != null)
         {
            ...
            this.var_533.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_533.add(_loc3_,_loc4_);
            ++this.var_168;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_533 != null)
         {
            ...
            return this.var_533.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1281.assign(_loc22_);
         }
         else
         {
            this.var_1281.assign(_loc17_);
         }
         ++this.var_168;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_91);
         _loc2_.x *= this.var_456;
         _loc2_.y *= this.var_459;
         _loc2_.z *= this.var_457;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1281);
         if(_loc3_ < this.var_2949 || _loc3_ > this.var_2950)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_91);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_456;
            _loc2_.y *= this.var_459;
            _loc2_.z *= this.var_457;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1281);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_91.x * this.var_456,this.var_91.y * this.var_459,this.var_91.z * this.var_457);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_158;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_456,param2.y * this.var_459,param2.z * this.var_457);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_456,param3.y * this.var_459,param3.z * this.var_457);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_456,param4.y * this.var_459,param4.z * this.var_457);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1206;
         }
         else
         {
            this.scale = const_767;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_767;
      }
