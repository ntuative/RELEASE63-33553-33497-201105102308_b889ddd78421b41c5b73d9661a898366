package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2979:IRoomContentLoader;
      
      private var var_640:IRoomObjectFactory = null;
      
      private var var_522:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1227:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_638 = [];
         this.var_639 = [];
         events.addEventListener(RoomContentLoadedEvent.const_442,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_532,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_714,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_640 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_640 == null || this.var_522 == null)
         {
            return;
         }
         this._state = const_1714;
         if(this.var_1227 != null)
         {
            _loc1_ = this.var_1227;
            this.var_1227 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_638.indexOf(_loc5_) < 0)
            {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_639.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_639.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_639.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_639[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_522.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_522.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_640.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_640 != null)
         {
            return this.var_640.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_638.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_986.indexOf(_loc2_) < 0)
         {
            this.var_986.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_986[0];
            this.var_986.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_55 == null || this.var_522 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_522.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_522.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_640.createRoomObjectLogic(_loc6_);
