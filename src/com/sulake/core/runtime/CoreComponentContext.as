package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1470:String = "asset-libraries";
      
      private static const const_1477:String = "library";
      
      private static const const_1474:String = "service-libraries";
      
      private static const const_1475:String = "library";
      
      private static const const_1476:String = "component-libraries";
      
      private static const const_1478:String = "library";
      
      private static const const_1473:String = "error_data";
      
      private static const const_1472:String = "error_cat";
      
      private static const const_1471:String = "error_desc";
       
      
      private var var_376:LibraryLoaderQueue;
      
      private var var_775:IEventDispatcher;
      
      private var var_515:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_816:
               ...
               var_407.addChild(new ProfilerViewer(this.var_204));
               break;
            case Core.const_477:
      ...
      {
         return this.var_515 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_262[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1473,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1472,String(param3));
         ErrorReportStorage.setParameter(const_1471,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_775 = loadingEventDelegate;
         if(this.var_376 == null)
         {
         ...
         try
         {
            node = config.child(const_1470)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_330,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_330,e);
         }
         try
         {
            node = config.child(const_1476)[0];
            if(node != null)
            {
               list = node.child(const_1478);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_330,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1850);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_775)
         {
            this.var_775.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_775)
         {
            ...
            this.var_775.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_775)
                  {
                     this.var_775.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_515 - this.var_376.length,this.var_515,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_204 ? 0 : this.var_1481 & 0;
         if(_loc3_ == Core.const_477)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_108)
         {
            ...
            {
               if(this.var_627[priority] < priority)
               {
                  ++this.var_627[priority];
                  skip = true;
               }
            }
            if(!skip)
