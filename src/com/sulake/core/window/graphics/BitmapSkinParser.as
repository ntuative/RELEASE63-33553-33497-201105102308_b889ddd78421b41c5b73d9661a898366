package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_105:String = "default";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_332 = SkinLayoutEntity.const_639;
                  break;
               case "move":
                  _loc5_.var_332 = SkinLayoutEntity.const_351;
                  break;
               case "strech":
                  _loc5_.var_332 = SkinLayoutEntity.const_589;
                  break;
               case "tiled":
                  _loc5_.var_332 = SkinLayoutEntity.const_313;
                  break;
               case "center":
                  _loc5_.var_332 = SkinLayoutEntity.const_563;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_331 = SkinLayoutEntity.const_639;
                  break;
               case "move":
                  _loc5_.var_331 = SkinLayoutEntity.const_351;
                  break;
               case "strech":
                  _loc5_.var_331 = SkinLayoutEntity.const_589;
                  break;
               case "tiled":
                  _loc5_.var_331 = SkinLayoutEntity.const_313;
                  break;
               case "center":
                  _loc5_.var_331 = SkinLayoutEntity.const_563;
            }
         }
