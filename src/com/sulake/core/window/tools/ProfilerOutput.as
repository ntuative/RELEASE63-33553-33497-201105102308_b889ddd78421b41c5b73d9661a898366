package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1426:Class = ProfilerOutput_profiler_dialog_xml;
      ...
      private var var_157:IProfiler;
      
      private var var_22:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_2932:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2932 = new Array();
         this.var_157 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1426() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_157)
         {
            this.var_157.removeStopEventListener(this.refresh);
            this.var_157 = null;
         }
         if(!this.var_157 && param1)
         {
            this.var_157 = param1;
            this.var_157.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_636)
            {
               this.var_1746 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_157.getProfilerAgentsInArray();
         ...
         if(this.var_1746)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_157.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_157.numBitmapAssetInstances + " / " + this.var_157.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_157.numTrackedBitmapDataInstances + " / " + this.var_157.numTrackedBitmapDataBytes + " bytes";
         }
      }
