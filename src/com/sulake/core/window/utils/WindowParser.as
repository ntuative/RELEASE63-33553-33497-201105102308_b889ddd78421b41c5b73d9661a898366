package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1259:String = "_EXCLUDE";
      
      public static const const_1999:String = "_INCLUDE";
      
      public static const const_1968:String = "_TEMP";
      
      private static const const_1459:String = "layout";
      
      private static const const_1044:String = "window";
      
      private static const const_1046:String = "variables";
      
      private static const const_1045:String = "filters";
      
      private static const const_464:String = "name";
      
      private static const const_1462:String = "style";
      
      private static const const_670:String = "params";
      
      private static const const_1455:String = "tags";
      ...
      private static const const_1467:String = "visible";
      
      private static const const_1465:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1271:String = "blend";
      
      private static const const_1460:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1464:String = "treshold";
      
      private static const const_1457:String = "children";
      
      private static const const_1461:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1468:String = "height_min";
      
      private static const const_1463:String = "height_max";
      
      private static const const_671:String = "true";
      
      private static const const_179:String = "0";
      ...
      private static const const_1456:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1466:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1074:Dictionary;
      
      protected var var_1606:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1328,this.var_1329);
         this.var_1074 = new Dictionary();
         this.var_1606 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1074,this.var_1606);
         this.var_2124 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1466,const_50);
         return param1.replace(const_1456,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1606)
            {
               delete this.var_1606[_loc1_];
            }
            this.var_2124.dispose();
            this.var_2124 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1459)
         {
            ...
            _loc9_ = param1.child(const_1045).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_464,variables,"")));
         style = uint(this.parseAttribute(xml,const_1462,variables,style));
         params = uint(this.parseAttribute(xml,const_670,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1455,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_179));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_179));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_179));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_179));
         visible = this.parseAttribute(xml,const_1467,variables,visible.toString()) == const_671;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_670).length() > 0)
         {
            list = xml.child(const_670).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_464,variables,"") as String;
               if(this.var_1074[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_464)) + "\"!");
               }
               params |= this.var_1074[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1465,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1458);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1461,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1468,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1463,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_671;
         blend = Number(this.parseAttribute(xml,const_1271,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1460,variables,window.clipping.toString()) == const_671;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1464,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1045).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1259) == -1)
                  {
