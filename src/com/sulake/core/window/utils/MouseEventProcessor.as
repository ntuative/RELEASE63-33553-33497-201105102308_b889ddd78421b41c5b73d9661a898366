package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_868:IWindowContextStateListener;
      ...
      {
         super();
         this.var_700 = new Point();
         if(var_339 == null)
         {
            var_339 = new Array();
            var_339[0] = MouseCursorType.const_338;
            var_339[1] = MouseCursorType.const_30;
            var_339[2] = MouseCursorType.const_338;
            var_339[3] = MouseCursorType.const_338;
            var_339[4] = MouseCursorType.const_338;
            var_339[5] = MouseCursorType.const_30;
            var_339[6] = MouseCursorType.const_338;
         }
         if(var_288 == null)
         {
            var_288 = new Array();
            var_288[0] = WindowState.const_88;
            var_288[1] = WindowState.const_90;
            var_288[2] = WindowState.const_89;
            var_288[3] = WindowState.const_72;
            var_288[4] = WindowState.const_56;
            var_288[5] = WindowState.const_96;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_60 = state.var_1321 as WindowController;
         this.var_173 = state.var_1319 as WindowController;
         this.var_171 = state.renderer;
         this.var_868 = state.var_1320;
         eventQueue.begin();
         this.var_700.x = -1;
         this.var_700.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_700.x || event.stageY != this.var_700.y)
            {
               this.var_700.x = event.stageX;
               this.var_700.y = event.stageY;
               array = new Array();
               this.var_81.groupParameterFilteredChildrenUnderPoint(this.var_700,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_60.getGlobalPosition(var_408);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_60 && !this.var_60.disposed)
                     {
                        ...
                        {
                           this.var_868.mouseEventReceived(event.type,this.var_60);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1321 = this.var_60;
         state.var_1319 = this.var_173;
         state.renderer = this.var_171;
         state.var_1320 = this.var_868;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_556))
         {
