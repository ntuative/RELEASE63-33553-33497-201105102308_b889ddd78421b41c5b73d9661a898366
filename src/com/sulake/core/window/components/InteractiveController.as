package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_603)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_982:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_603)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_982,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1594);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1327)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_716,param1.toolTipDelay,PropertyStruct.const_240,true));
         }
         else
         {
      ...
      {
         this.var_1341 = param1 == null ? "null" : param1;
      }
