package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1365:String = "_TITLE";
      
      private static const const_1366:String = "_HEADER";
      
      private static const const_1368:String = "_CONTENT";
      
      private static const const_1367:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1353:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1365) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1353 = findChildByTag(const_1366) as IHeaderWindow;
            if(!this.var_1353)
            {
      ...
      {
         return findChildByTag(const_1367) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_282);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_282,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_282,false);
            }
