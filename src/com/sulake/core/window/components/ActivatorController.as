package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_354)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1137)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_867;
         if(this.var_867 != param1)
         {
            if(this.var_867 != null)
            {
               if(!this.var_867.disposed)
               {
                  this.var_867.deactivate();
               }
            }
            this.var_867 = param1;
