package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_567 != PropertyDefaults.const_1242)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_885,this.var_567,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1659);
         }
         if(this.var_864 != PropertyDefaults.const_1275)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_906,this.var_864,PropertyStruct.const_52,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1870);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_906:
                  this.var_864 = _loc2_.value as String;
                  break;
            }
         }
