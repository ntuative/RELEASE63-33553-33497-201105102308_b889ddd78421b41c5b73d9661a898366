package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1343:Dictionary = createPropertySetterTable();
      ...
      protected var var_1073:Boolean = false;
      ...
      private static function method_4(param1:TextController, param2:String) : void
      {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_780 ? true : null;
         }
      ...
      {
         this.var_865 = param1;
         this._field.scrollH = this.var_865 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_865 * this.maxScrollH,this.var_569 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_851,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1120));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1114 ? new PropertyStruct(PropertyDefaults.const_977,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1314) : PropertyDefaults.const_1636);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_240,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1190 ? new PropertyStruct(PropertyDefaults.const_1173,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1316) : PropertyDefaults.const_1839);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_968) ? new PropertyStruct(PropertyDefaults.const_404,this._field.textColor,PropertyStruct.const_165,true) : PropertyDefaults.const_1296);
         _loc1_.push(this.var_432 != TextStyleManager.const_214 ? new PropertyStruct(PropertyDefaults.const_434,this.var_432,PropertyStruct.const_52,true,PropertyDefaults.const_765) : PropertyDefaults.const_1141);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_750 ? new PropertyStruct(PropertyDefaults.const_192,this.var_39.left,PropertyStruct.const_38,true) : PropertyDefaults.const_801);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_749 ? new PropertyStruct(PropertyDefaults.const_187,this.var_39.top,PropertyStruct.const_38,true) : PropertyDefaults.const_773);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_882 ? new PropertyStruct(PropertyDefaults.const_177,this.var_39.right,PropertyStruct.const_38,true) : PropertyDefaults.const_880);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_836 ? new PropertyStruct(PropertyDefaults.const_190,this.var_39.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_723);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1142 ? new PropertyStruct(PropertyDefaults.const_722,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1712);
