package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1879:StyleSheet = null;
      ...
      {
         this.var_790 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1213 == param2)
         {
            return;
         }
         param1.var_1213 = param2;
         param1.var_1879 = null;
         if(param1.var_1213 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1213);
            param1.var_1879 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_958.indexOf(param1) > -1)
         {
            this.var_790 = param1;
         }
      }
      ...
      {
         return this.var_790 == LinkTarget.const_30 ? defaultLinkTarget : this.var_790;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1879;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_790 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_696,this.var_790,PropertyStruct.const_52,true,PropertyDefaults.const_958));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1791);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_696)
            {
               this.var_790 = _loc2_.value as String;
               break;
            }
