package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1301:IItemListWindow;
      
      private var var_468:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_468)
         {
            this.var_468.removeEventListener(WindowEvent.const_254,this.scrollBarEventProc);
            this.var_468.removeEventListener(WindowEvent.const_251,this.scrollBarEventProc);
            this.var_468 = null;
         }
         if(this.var_1301)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1301)
         {
            this.var_1301 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_468)
         {
            this.var_468 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_468)
            {
               this.var_468.addEventListener(WindowEvent.const_254,this.scrollBarEventProc);
               this.var_468.addEventListener(WindowEvent.const_251,this.scrollBarEventProc);
            }
         }
         return this.var_468;
      }
