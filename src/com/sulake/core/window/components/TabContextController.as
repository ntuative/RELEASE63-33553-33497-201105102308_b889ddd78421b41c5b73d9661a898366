package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1561:String = "_SELECTOR";
      
      private static const const_1560:String = "_CONTENT";
       
      
      protected var var_1078:ITabSelectorWindow;
      
      protected var var_2144:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1078 = findChildByTag(const_1561) as ITabSelectorWindow;
            if(this.var_1078 != null)
            {
               this.var_1078.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2144 = findChildByTag(const_1560) as IWindowContainer;
         }
      ...
      {
         return !!this.var_762 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1078.numSelectables;
      }
