package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1611:uint = 500;
      
      protected var var_1341:String = "";
      
      protected var var_1324:Boolean = false;
      
      protected var var_762:Boolean = false;
      ...
      {
         this.var_1341 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_762 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_191,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_380,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_305,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_763,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1732);
         _loc1_.push(this.var_1324 != PropertyDefaults.const_1253 ? new PropertyStruct(PropertyDefaults.const_850,this.var_1324,PropertyStruct.const_39,true) : PropertyDefaults.const_1830);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1241 ? new PropertyStruct(PropertyDefaults.const_697,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1742);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1205 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1882);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_850:
                  this.var_1324 = _loc2_.value as Boolean;
                  if(this.var_1324)
                  {
               ...
               case PropertyDefaults.const_763:
                  ...
                  break;
               case PropertyDefaults.const_1210:
