package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1400:String = "increment";
      
      private static const const_1401:String = "decrement";
      
      private static const const_1027:String = "slider_track";
      ...
      protected var var_697:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_16.removeEventListener(WindowEvent.const_43,this.onScrollableResized);
            this.var_16.removeEventListener(WindowEvent.const_596,this.onScrollableScrolled);
         }
         this.var_16 = param1;
         if(this.var_16 != null && !this.var_16.disposed)
         {
            this.var_16.addEventListener(WindowEvent.const_43,this.onScrollableResized);
            this.var_16.addEventListener(WindowEvent.const_596,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_926 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1027) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         if(param2.type == WindowEvent.const_559)
         {
            if(this.var_16 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_308)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_697;
                  }
                  else
                  {
                     this.scrollV -= this.var_697;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_926)
         {
            ...
            else if(param2.name == const_1401)
            {
               if(this.var_16)
               {
                  this.var_1157 = true;
            ...
            else if(param2.name == const_1027)
            {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_926) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_926) as IScrollableWindow;
               if(_loc1_)
               {
