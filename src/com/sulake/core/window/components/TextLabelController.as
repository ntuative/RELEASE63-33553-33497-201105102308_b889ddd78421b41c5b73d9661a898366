package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_341:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_341);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2176 = _loc2_.textWidth;
         this.var_2175 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_341 != _loc2_.color : this.var_341 != null && this.var_341 != PropertyDefaults.const_968) ? new PropertyStruct(PropertyDefaults.const_404,this.var_341,PropertyStruct.const_165,true) : PropertyDefaults.const_1296);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_750)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_192,this.var_39.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_801);
            }
            if(this.var_39.top != PropertyDefaults.const_749)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_187,this.var_39.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_773);
            }
            if(this.var_39.right != PropertyDefaults.const_882)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_177,this.var_39.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_880);
            }
            if(this.var_39.bottom != PropertyDefaults.const_836)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_190,this.var_39.bottom,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_723);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_404:
                  this.var_341 = _loc2_.value as uint;
                  break;
