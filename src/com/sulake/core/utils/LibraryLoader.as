package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1897:uint = 1;
      
      protected static const const_1898:uint = 2;
      
      protected static const const_1899:uint = 4;
      
      protected static const const_1896:uint = 3;
      ...
      public static const const_1247:Boolean = false;
      
      public static const const_1634:int = 2;
      
      private static var var_945:Array = new Array();
      
      private static var var_753:Array = new Array();
      ...
      protected var var_1072:Boolean = false;
      
      protected var var_2911:String = "";
      
      protected var var_2909:String = "";
      
      protected var var_2123:int;
      
      protected var var_1326:int;
      
      protected var var_1327:int;
      
      protected var var_2991:uint = 0;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1247)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_753[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_753.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_753.length < const_1634 && false)
            {
               _loc1_ = var_945.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1071 ? uint(this.var_1326 - this.var_2123) : uint(getTimer() - this.var_2123);
      }
      ...
      {
         if(this.var_1072 && !_disposed)
         {
            this.var_1072 = false;
            if(!this.var_1071 && this.var_238)
            {
               this.var_1326 = -1;
               this.var_2123 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1071 && !_disposed && this.var_1327 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_238,const_1819 - this.var_1327);
            if(this.var_2910)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_476 == LibraryLoader.const_1896)
         {
