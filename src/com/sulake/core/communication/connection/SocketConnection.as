package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1710:int = 10000;
      ...
      private var var_489:ByteArray;
      
      private var var_1106:IEncryption;
      
      private var var_714:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_274 = param2;
         this.var_489 = new ByteArray();
         this.var_1105 = new MessageClassManager();
         this.var_70 = new Socket();
         this.var_196 = new Timer(const_1710,1);
         this.var_196.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_196.stop();
            this.var_196.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_196 = null;
         this.var_489 = null;
         this.var_488 = null;
      ...
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_274.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_274.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc6_:ByteArray = this.var_714.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_488)
         {
         ...
         {
            _loc3_ = this.var_1106.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_714.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_714.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1106 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_714.getMessages(this.var_489,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               {
                  eventsForClass = this.var_274.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_274.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_489,offset);
               this.var_489 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_489.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_489.writeByte(this.var_70.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_196.stop();
         this.var_1646 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_713));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1646 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_713));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_713));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_713));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_713));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_713));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_196.delay + " ms). Possible Firewall.";
