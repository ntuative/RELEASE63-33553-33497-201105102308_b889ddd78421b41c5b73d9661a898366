package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_521:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_521 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_104 is BitmapDataAsset)
         {
            ...
            this.var_1519 = BitmapDataAsset(this.var_104).var_1519;
            this.var_1520 = BitmapDataAsset(this.var_104).var_1520;
            if(this._bitmap != null)
            {
               this.var_104 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1519 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1520 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
