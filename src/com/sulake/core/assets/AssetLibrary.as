package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1312:String = "AssetLibraryReady";
      
      public static const const_912:String = "AssetLibraryLoaded";
      
      public static const const_1690:String = "AssetLibraryUnloaded";
      
      public static const const_1824:String = "AssetLibraryLoadError";
      
      private static const const_464:String = "name";
      
      private static const const_1090:String = "asset";
      
      private static const const_1088:String = "param";
      ...
      private static var var_2016:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_546:uint = 0;
      
      private static var var_1038:Array = new Array();
      ...
      private var var_1037:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_546;
         this.var_465 = new Dictionary(false);
         this.var_545 = new Dictionary(false);
         this.var_1039 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1089);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1090);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_464);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1088);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1038.splice(var_1038.indexOf(this),1);
            --var_546;
            this.var_545 = null;
            this.var_1039 = null;
            this.var_169 = null;
      ...
      {
         if(this.var_665 == param1.url && this.var_1036)
         {
            if(!this.var_1037 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_666);
            }
            this.var_1037 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1312));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1039)
         {
            delete this.var_1039[_loc1_];
         }
         if(this.var_42 != null)
         {
            this.var_42.dispose();
         ...
         this.var_1036 = false;
         this.var_665 = null;
         dispatchEvent(new Event(AssetLibrary.const_1690));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1039[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1313,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1332,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1201,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_464;
                     this.var_463.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_463.length ? this.getAssetByName(this.var_463[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_169)
         {
            ...
            {
               return this.var_463.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2016.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_169)
            {
               if(this.var_169[_loc2_] == param1)
               {
                  this.var_463.splice(this.var_463.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_465.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_465[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_465[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_465)
         {
            _loc3_ = AssetTypeDeclaration(this.var_465[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_465)
         {
            _loc4_ = AssetTypeDeclaration(this.var_465[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1824));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1089);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1090);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_464).toString() == param1)
               {
                  ...
                  _loc6_ = _loc3_.child(const_1088);
                  if(_loc6_.length())
                  {
