package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_1076:LoaderContext;
      
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         super();
         this.var_1069 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1076 = new LoaderContext();
         this.var_1076.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1076);
         }
      }
      ...
      {
         this.var_1069 = param1.url;
         var_335 = 0;
         this.var_42.load(param1,this.var_1076);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_335 < var_2908)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1069 + (this.var_1069.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_335),this.var_1076);
               return true;
            }
         }
         return false;
