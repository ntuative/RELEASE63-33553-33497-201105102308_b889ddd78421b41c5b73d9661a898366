package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_34:IRoomWidgetFactory;
      ...
      private var var_1184:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_109:IHabboHelp;
      ...
      private var var_260:PerformanceTracker = null;
      ...
      private var var_624:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_260 = new PerformanceTracker();
         this.var_431 = new FramerateTracker();
         this.var_259 = new LatencyTracker();
         this.var_625 = new LagWarningLogger();
         this.var_624 = new ToolbarClickTracker(this);
         this.var_1462 = new Array(const_1038);
         var _loc4_:int = 0;
         while(_loc4_ < const_1038)
         {
            this.var_1462[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1831,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1851,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1184)
            {
               this.var_1184.release(new IIDHabboWindowManager());
               this.var_1184 = null;
            }
            if(this.var_306)
            {
            ...
            if(this.var_34)
            {
               this.var_34.release(new IIDHabboRoomWidget());
               this.var_34 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_202)
            {
               if(!this.var_202.disposed)
               {
                  ...
                  Component(this.var_202).events.removeEventListener(HabboFriendListTrackingEvent.const_433,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_109)
            {
               if(!this.var_109.disposed)
               {
                  this.var_109.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_109.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_109.release(new IIDHabboHelp());
               this.var_109 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_310,this.onRoomAction);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_181)
         {
            if(this.var_259 != null)
            {
               this.var_259.configuration = this.var_181;
            }
            if(this.var_260 != null)
            {
               this.var_260.configuration = this.var_181;
            }
            ...
            if(this.var_181)
            {
               ...
               {
                  this.var_625.configure(this.var_181);
               }
               if(this.var_431 != null)
               {
               ...
               {
                  this.var_624.configure(this.var_181);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_902,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_222,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_272,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_821,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_71,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_475,this.onHotelViewEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_821)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1869);
         }
         else if(param1.type == HabboHotelViewEvent.const_475)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1646);
         }
         else if(param1.type == HabboHotelViewEvent.const_71)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1826);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_902:
            ...
            case HabboCommunicationEvent.const_222:
               this.trackLoginStep(HabboLoginTrackingStep.const_222);
               break;
      ...
      {
         this.var_1184 = IHabboWindowManager(param2);
         if(this.var_1184)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_181)
            {
               if(this.var_181.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1462)
                  {
                  ...
                  if(this.var_260 != null)
                  {
                     _loc4_["null"] = this.var_260.flashVersion;
                     _loc4_["null"] = this.var_260.averageUpdateInterval;
                  }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1246,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_202).events.addEventListener(HabboFriendListTrackingEvent.const_433,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_433:
      ...
      {
         this.var_34 = param2 as IRoomWidgetFactory;
         Component(this.var_34).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_34).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_34).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_34).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_109 = param2 as IHabboHelp;
         this.var_109.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_109.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2508)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1793);
            this.var_2508 = true;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_310,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_306.events.addEventListener(AdEvent.const_592,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_310)
         {
            if(this.var_1807 < 1)
            {
               if(!this.var_302)
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_431)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_431.frameRate),_loc2_);
                  ++this.var_1807;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_624)
         {
            this.var_624.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1808;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1808);
         }
         if(this.var_510 > -1 && _loc2_ - this.var_510 > 15000)
         {
            ++this.var_1809;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1809);
         }
         this.var_510 = _loc2_;
         if(this.var_260 != null)
         {
         ...
         if(this.var_259 != null)
         {
            this.var_259.update(param1,this.var_510);
         }
         if(this.var_431 != null)
         {
            this.var_431.trackUpdate(param1,this,this.var_510);
         }
         if(this.var_625 != null)
         {
