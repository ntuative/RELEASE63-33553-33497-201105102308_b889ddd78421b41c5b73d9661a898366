package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_1058:Number = 0.25;
      
      private static const const_1261:Number = 0.25;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_248 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_444 || param1 == this.var_442)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_443;
                  while(_loc6_ < this.var_445)
                  {
               ...
               if(param2 == this.var_443 || param2 == this.var_445)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_444;
                  while(_loc8_ < this.var_442)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc2_ < this._height)
         {
            ...
            {
               this.var_642[_loc2_][_loc8_] = this.var_121[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         ...
         this.var_875 = getFloorHeight(this.var_121);
         if(!param1)
         {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_253,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_412,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1261 * this.var_1394;
         var _loc9_:Number = const_1058 * this._floorThicknessMultiplier;
         ...
         this.addPlane(RoomPlaneData.const_253,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_253,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_253,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_253,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_276,param1,param2,param3);
         var _loc13_:IVector3d = param1;
         var _loc14_:* = null;
         var _loc15_:* = null;
         if(_loc12_)
         {
            _loc16_ = const_1058 * this._floorThicknessMultiplier;
            if(param8 > 0)
            {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_276,_loc13_,new Vector3d(0,0,-_loc16_),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_276,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_276,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_276,_loc13_,new Vector3d(0,0,-_loc16_),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_248}" height="{this._height}" wallHeight="{this.var_1513}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc4_ = <tileRow/>;
            _loc5_ = this.var_642[_loc2_];
            _loc6_ = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1249;
         }
         var _loc2_:RoomPlaneData = this.var_131[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
