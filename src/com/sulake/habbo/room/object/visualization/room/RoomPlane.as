package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_909:IPlaneRasterizer = null;
      ...
      private var var_418:PlaneBitmapData = null;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_909.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_418;
         if(_loc3_ == null)
         {
         ...
         if(this.var_728 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_355))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_909 != null)
            {
               _loc3_ = this.var_909.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1703,this.var_2330,this.var_2326,this.var_2329,this.var_2327,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1702 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            originPos = geometry.getScreenPosition(this.var_1140);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_155.z - originZ,this.var_112.z - originZ,this.var_85.z - originZ,this.var_113.z - originZ);
            ...
            this.var_1702 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2325);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_910)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_356.length)
            {
               _loc5_ = this.var_356[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_250.length == this.var_911.length)
         {
            while(_loc1_ < this.var_250.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_911[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_356.length > this.var_1395.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_910 || this.var_250.length == 0 && this.var_356.length == 0 && !this.var_355 || this.var_832 == null)
         {
            return;
         }
         ...
         if(this.var_355)
         {
            ...
            while(_loc5_ < this.var_250.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc3_.leftSideLoc / this.var_324.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc3_.rightSideLoc / this.var_323.length;
                  _loc12_ = _loc3_.type;
                  this.var_832.updateMask(this.var_66,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_911.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_356.length)
            {
               _loc4_ = this.var_356[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc4_.leftSideLoc / this.var_324.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc4_.rightSideLoc / this.var_323.length;
                  _loc13_ = this.var_66.width * _loc4_.leftSideLength / this.var_324.length;
                  _loc14_ = this.var_66.height * _loc4_.rightSideLength / this.var_323.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_220.copyChannel(param1,param1.rect,const_657,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_220.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_220,this.var_220.rect,const_657,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
