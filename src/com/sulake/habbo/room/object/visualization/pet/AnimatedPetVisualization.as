package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1380:String = "head";
      
      private static const const_652:int = 1;
      
      private static const const_1004:int = 1000;
      
      private static const const_1381:String = "pet_experience_bubble_png";
      
      private static const const_1382:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1381) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_349 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_286);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_166);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_286);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1727 = _loc3_.getNumber(RoomObjectVariableEnum.const_405) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_226);
            if(!isNaN(_loc8_))
            {
               this.var_1664 = _loc8_;
            }
            else
            {
               this.var_1664 = direction;
            }
            this.var_1370 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2211 = _loc3_.getNumber(RoomObjectVariableEnum.const_713);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_799);
            if(_loc9_ != this.var_1663)
            {
               this.var_1663 = _loc9_;
               this.var_2242 = this.var_1663.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_349 != null)
         {
            ...
            if(this.var_1370 > 0)
            {
               _loc2_ = param1 - this.var_1370;
               if(_loc2_ < const_1004)
               {
                  this.var_349.alpha = int(Math.sin(_loc2_ / const_1004 * 0) * 255);
                  this.var_349.setExperience(this.var_2211);
               }
               else
               {
                  this.var_1370 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_349.alpha > 0)
                  {
                     _loc3_.asset = this.var_349.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_349.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_110.length)
         {
            _loc5_ = this.var_110[_loc4_];
            if(_loc5_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2242);
         }
         return null;
      }
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1664);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_88,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1380)
            {
               this.var_888[param1] = true;
            }
            else
            {
               this.var_888[param1] = false;
            }
         }
