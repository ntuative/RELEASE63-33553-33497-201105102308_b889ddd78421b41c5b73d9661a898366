package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1581:String = "shore";
      ...
      {
         if(this.var_2897 == param1 && this.var_2898 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1581)
            {
               this.var_2080 = _loc2_;
               this.var_2897 = param1;
               this.var_2898 = direction;
               return this.var_2080;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1316.indexOf(_loc2_) < 0)
            {
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_691[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_691[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_562 == 0 || this.var_692 == 0)
         {
            ...
            this.var_562 = _loc2_.getNumber(RoomObjectVariableEnum.const_350);
            this.var_692 = _loc2_.getNumber(RoomObjectVariableEnum.const_430);
         }
         this.var_472 = [];
         this.var_691 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_562 * 2 + this.var_692 * 2)
         {
            this.var_472.push(false);
            this.var_691.push(ShoreMaskCreatorUtility.const_80);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_66,getSize(param3),this.var_472,this.var_691,assetCollection);
      }
