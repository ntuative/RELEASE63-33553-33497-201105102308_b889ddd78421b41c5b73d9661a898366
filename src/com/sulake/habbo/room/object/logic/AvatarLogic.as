package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      private static const const_1059:Number = 1.5;
      
      private static const const_1061:int = 28;
      
      private static const const_1060:int = 29;
      
      private static const const_1062:int = 500;
      
      private static const const_1521:int = 999999999;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_145,RoomObjectMoveEvent.const_417,RoomObjectMouseEvent.const_184,RoomObjectMouseEvent.const_193,RoomObjectFurnitureActionEvent.const_257,RoomObjectFurnitureActionEvent.const_329];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarPostureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_695,_loc3_.parameter);
            return;
         }
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            this.var_1470 = getTimer() + _loc4_.numberOfWords * 1000;
            return;
         }
         if(param1 is RoomObjectAvatarTypingUpdateMessage)
         {
            _loc5_ = param1 as RoomObjectAvatarTypingUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_1282,Number(_loc5_.isTyping));
            return;
         }
         ...
         if(param1 is RoomObjectAvatarDanceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1276,_loc9_.danceStyle);
            return;
         }
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarSleepUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_405,Number(_loc10_.isSleeping));
            return;
         }
         if(param1 is RoomObjectAvatarPlayerValueUpdateMessage)
         {
            _loc11_ = param1 as RoomObjectAvatarPlayerValueUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_703,_loc11_.value);
            this.var_1523 = getTimer() + 3000;
            return;
         }
         ...
         if(param1 is RoomObjectAvatarCarryObjectUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_591,_loc15_.itemType);
            if(_loc15_.itemType < const_1521)
            {
               this.var_996 = getTimer() + 100000;
               this.var_1925 = true;
            }
            else
            {
               this.var_996 = getTimer() + 1500;
               this.var_1925 = false;
            }
            return;
         }
         if(param1 is RoomObjectAvatarUseObjectUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_435,_loc16_.itemType);
            return;
         }
         if(param1 is RoomObjectAvatarSignUpdateMessage)
         {
            _loc17_ = param1 as RoomObjectAvatarSignUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_1126,_loc17_.signType);
            this.var_1522 = getTimer() + 5000;
            return;
         }
         if(param1 is RoomObjectAvatarFlatControlUpdateMessage)
         {
            _loc18_ = param1 as RoomObjectAvatarFlatControlUpdateMessage;
            _loc2_.setString(RoomObjectVariableEnum.const_721,_loc18_.rawData);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1639,Number(_loc18_.isAdmin));
            return;
         }
      ...
      {
         if(param1 == const_1061)
         {
            this.var_800 = getTimer() + const_1062;
            this.var_1524 = const_1060;
         }
         else if(param3.getNumber(RoomObjectVariableEnum.const_533) == const_1060)
         {
            this.var_800 = getTimer() + const_1062;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         if(this.var_1470 > 0)
         {
            ...
            else if(this.var_997 == 0 && this.var_801 == 0)
            {
               this.var_801 = param1 + this.getTalkingPauseInterval();
               this.var_997 = this.var_801 + this.getTalkingPauseLength();
            }
            else if(this.var_801 > 0 && param1 > this.var_801)
            {
               param2.setNumber(RoomObjectVariableEnum.const_295,0);
               this.var_801 = 0;
            }
            else if(this.var_997 > 0 && param1 > this.var_997)
            {
         ...
         if(this.var_1522 > 0 && param1 > this.var_1522)
         {
            param2.setNumber(RoomObjectVariableEnum.const_1126,0);
            this.var_1522 = 0;
         }
         if(this.var_996 > 0)
         {
            ...
            {
               param2.setNumber(RoomObjectVariableEnum.const_591,0);
               this.var_996 = 0;
            }
            else if((this.var_996 - param1) % 10000 < 1000 && this.var_1925)
            {
               param2.setNumber(RoomObjectVariableEnum.const_435,1);
            }
            else
            {
         ...
         {
            param2.setNumber(RoomObjectVariableEnum.const_748,1);
            this.var_1926 = param1 + this.getBlinkInterval();
            this.var_1525 = param1 + this.getBlinkLength();
         }
         if(this.var_1525 > 0 && param1 > this.var_1525)
         {
            param2.setNumber(RoomObjectVariableEnum.const_748,0);
            this.var_1525 = 0;
         }
         if(this.var_800 > 0 && param1 > this.var_800)
         {
            param2.setNumber(RoomObjectVariableEnum.const_533,this.var_1524);
            this.var_800 = 0;
         }
         if(this.var_1523 > 0 && param1 > this.var_1523)
         {
            param2.setNumber(RoomObjectVariableEnum.const_703,0);
            this.var_1523 = 0;
         }
      }
      ...
      private function targetIsWarping(param1:IVector3d) : Boolean
      {
         ...
         if(Math.abs(_loc2_.x - param1.x) > const_1059 || Math.abs(_loc2_.y - param1.y) > const_1059)
         {
            return true;
         }
         return false;
