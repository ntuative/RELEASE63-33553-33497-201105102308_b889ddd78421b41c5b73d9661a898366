package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_544,RoomObjectFurnitureActionEvent.const_507,RoomObjectFurnitureActionEvent.const_508,RoomObjectFurnitureActionEvent.const_586,RoomObjectWidgetRequestEvent.const_149];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_306,RoomWidgetInfostandExtraParamEnum.const_548);
            ...
            if(_loc4_ != this.var_2195)
            {
               this.var_2195 = _loc4_;
               if(_loc4_ == 1)
               {
