package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_210,RoomObjectRoomAdEvent.const_328,RoomObjectRoomAdEvent.const_345];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_441,"");
         _loc2_.setString(RoomObjectVariableEnum.const_863,"");
      ...
      {
         super.update(param1);
         if(this.var_1527 > 0 && param1 > this.var_1527)
         {
            this.adDelayTimeout();
            this.var_1527 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1290:
                  _loc2_.setString(RoomObjectVariableEnum.const_441,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_863,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_516,Number(true));
                  this.var_1527 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1302);
            }
         }
      }
      ...
      override public function method_1(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_593)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_863);
