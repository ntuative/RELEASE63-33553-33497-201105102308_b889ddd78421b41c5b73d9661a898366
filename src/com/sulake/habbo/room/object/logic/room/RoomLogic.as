package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1865:int = 255;
      
      private var var_1210:int = 0;
      
      private var var_1864:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_627,RoomObjectMouseEvent.const_145];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1322,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_728,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_929,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_712,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_840,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1210)
         {
            ...
            if(_loc2_ - this.var_1210 >= this.var_1864)
            {
               _loc3_ = this.var_1209;
               _loc4_ = this.var_1865;
               this.var_1210 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1209 >> 16 & 255;
               _loc11_ = this.var_1209 >> 8 & 255;
               _loc12_ = this.var_1209 & 255;
               _loc13_ = (_loc2_ - this.var_1210) / this.var_1864;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1867 + (this.var_1865 - this.var_1867) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_728,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_577:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_241)
               {
                  _loc5_ = "null";
               }
               this.var_495.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_858:
               _loc4_ = this.var_495.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_495.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1215,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1161:
               param2.setNumber(RoomObjectVariableEnum.const_712,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_840,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1058:
               param2.setNumber(RoomObjectVariableEnum.const_1197,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1261:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1243,int(param1.bgOnly));
         this.var_1495 = this._color;
         this.var_1867 = this.var_1866;
         this.var_1209 = _loc3_;
         this.var_1865 = _loc4_;
      ...
      override public function method_1(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_498,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1816,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1625,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1767,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_498,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_253 || _loc12_ == RoomPlaneData.const_412)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
