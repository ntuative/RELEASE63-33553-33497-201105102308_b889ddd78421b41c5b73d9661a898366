package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1026.indexOf(param1) < 0)
         {
            this.var_1026.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1287.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_1026.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_1026.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1287.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1287.getValue(param1) == null)
         {
            this.var_1287.add(param1,true);
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.BOT:
               _loc2_ = AvatarLogic;
               break;
            case RoomObjectLogicEnum.const_53:
               _loc2_ = PetLogic;
               break;
            ...
            case RoomObjectLogicEnum.const_1863:
               ...
               break;
            case RoomObjectLogicEnum.const_1664:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1987.getValue(param1) == null)
            {
               this.var_1987.add(param1,true);
