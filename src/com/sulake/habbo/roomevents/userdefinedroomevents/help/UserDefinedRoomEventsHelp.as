package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1679 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1124 = this.var_1679.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1124)
         {
            this.var_1124.procedure = this.onButtonClick;
         }
         this.var_1125 = this.var_1679.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1125)
         {
      ...
      {
         if(this.var_246 >= this.var_58.length - 1)
         {
      ...
      {
         ++this.var_246;
         this.var_246 = Math.min(this.var_246,this.var_58.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_58[this.var_246][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_58[this.var_246][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_58[this.var_246][1]).value;
