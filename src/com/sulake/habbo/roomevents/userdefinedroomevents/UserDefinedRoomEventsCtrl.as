package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1579:int = 2;
      ...
      private var var_2044:TriggerConfs;
      
      private var var_2043:ActionTypes;
      
      private var var_2042:ConditionTypes;
      
      private var var_276:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_842:RoomObjectHightLighter;
      
      private var var_109:UserDefinedRoomEventsHelp;
      
      private var var_1300:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2044 = new TriggerConfs();
         this.var_2043 = new ActionTypes();
         this.var_2042 = new ConditionTypes();
         this.var_276 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_842 = new RoomObjectHightLighter(param1);
         this.var_109 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_276[param1];
            this.var_842.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_36.furniLimit)
         {
            this.var_276[param1] = param2;
            this.var_842.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1300 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_80.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_842.hideAll(this.var_276);
         }
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_109.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1579) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1579 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2044);
         this.refreshConfigureElement(this.var_2043);
         this.refreshConfigureElement(this.var_2042);
