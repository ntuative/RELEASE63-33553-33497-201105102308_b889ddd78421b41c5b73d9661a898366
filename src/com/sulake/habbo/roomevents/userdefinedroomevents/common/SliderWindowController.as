package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1313:Number = 1.0;
      
      private var var_688:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1313,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1062);
         }
      ...
      {
         return int(this.var_1830 * (Number(param1 - this._minValue) / (this.var_1313 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1830 * (this.var_1313 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1061)
         {
            if(param1.type == WindowMouseEvent.const_54 || param1.type == WindowMouseEvent.const_204)
            {
               this.var_1061 = false;
            }
         }
         if(!this.var_1061 || param1.type != WindowEvent.const_362)
         {
            return;
         }
         if(this.var_688 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_688) * this.var_688;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_688 != 0)
            {
               _loc3_ = this.var_1062 + this.var_688;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            {
               _loc2_.bitmap = new BitmapData(this.var_777.width,this.var_777.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_777,this.var_777.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1830 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_777 = BitmapData(_loc2_.content);
      }
   }
}
