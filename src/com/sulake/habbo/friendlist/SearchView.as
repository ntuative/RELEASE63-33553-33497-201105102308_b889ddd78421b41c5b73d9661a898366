package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_797:ITextFieldWindow;
      
      private var _list:IItemListWindow;
      
      private var var_672:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_672 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_797 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_797.procedure = this.onSearchInput;
         this.var_797.addEventListener(WindowKeyboardEvent.const_191,this.onSearchStrInput);
      ...
      public function refreshList() : void
      {
         ...
         while(true)
         {
            if(_loc2_ == 0)
            {
               this.method_2(true,_loc2_,null,null,this.getFriendsCaption(),false,false,false,0);
            }
            else if(_loc2_ <= _loc1_.friends.length)
            {
               _loc3_ = _loc1_.friends[_loc2_ - 1];
               this.method_2(true,_loc2_,_loc3_.avatarFigure,_loc3_.avatarName,null,!_loc3_.isAvatarOnline,_loc3_.isAvatarOnline,false,_loc3_.avatarId);
            }
            else if(_loc2_ == _loc1_.friends.length + 1)
            {
               this.method_2(true,_loc2_,null,null,this.getOthersCaption(),false,false,false,0);
            }
            else if(_loc2_ <= _loc1_.friends.length + _loc1_.others.length + 1)
            {
               _loc4_ = _loc1_.others[_loc2_ - 2 - _loc1_.friends.length];
               this.method_2(true,_loc2_,_loc4_.avatarFigure,_loc4_.avatarName,null,false,false,_loc4_.avatarId != this._friendList.avatarId && !this._friendList.searchResults.isFriendRequestSent(_loc4_.avatarId),_loc4_.avatarId);
            }
            else
            {
               _loc5_ = this.method_2(false,_loc2_,null,null,null,false,false,false,0);
               if(_loc5_)
               {
                  break;
               }
      ...
      private function method_2(param1:Boolean, param2:int, param3:String, param4:String, param5:String, param6:Boolean, param7:Boolean, param8:Boolean, param9:int) : Boolean
      {
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_672.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_672.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_672.closePopup();
         }
      }
      ...
      private function onAskForFriendButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else
         {
            ...
            this.method_2(true,this.findIndexFor(_loc3_.avatarId),_loc3_.avatarFigure,_loc3_.avatarName,null,false,false,false,_loc3_.avatarId);
         }
      }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_797.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_797.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_797.text;
