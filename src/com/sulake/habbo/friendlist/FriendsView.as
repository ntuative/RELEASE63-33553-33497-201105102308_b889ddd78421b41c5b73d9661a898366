package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2023:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2743:IContainerButtonWindow;
      
      private var var_2744:IContainerButtonWindow;
      
      private var var_2746:IContainerButtonWindow;
      
      private var var_2745:IContainerButtonWindow;
      ...
      {
         this.var_2743 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2744 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2746 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2745 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      public function refreshList() : void
      {
         ...
         {
            this.method_2(true,_loc1_,_loc2_,null);
            _loc1_++;
            if(_loc2_.open)
            {
               ...
               while(_loc5_ < _loc4_)
               {
                  this.method_2(true,_loc1_,_loc2_,_loc2_.friends[_loc5_]);
                  _loc1_++;
                  _loc5_++;
               }
            }
         ...
         while(true)
         {
            _loc6_ = this.method_2(false,_loc1_,null,null);
            if(_loc6_)
            {
               break;
            }
      ...
      private function method_2(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2743,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2744,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2746,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2745,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_672.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_672.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_672.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_164)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_164 && _loc4_.online)
            {
