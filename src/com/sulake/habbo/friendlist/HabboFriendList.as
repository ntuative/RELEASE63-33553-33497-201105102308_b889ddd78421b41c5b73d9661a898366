package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_410:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1872:OpenedToWebPopup;
      ...
      private var var_1873:AvatarSearchResults;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1873 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_636.stop();
            this.var_636.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_636 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1872 = new OpenedToWebPopup(this);
         }
         this.var_1872.show(x,y);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.FRIENDLIST);
      ...
      {
         this.var_1058 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1209,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_414,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_101.addFriend(new Friend(_loc4_));
         }
         this.var_410 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_636)
         {
            this.var_636 = new Timer(120000);
            this.var_636.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_636.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_141,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_414);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_410.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_433));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_410.findTab(FriendListTab.const_100).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_410.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1873.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_410.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_787 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_787.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_787.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_46))
         {
