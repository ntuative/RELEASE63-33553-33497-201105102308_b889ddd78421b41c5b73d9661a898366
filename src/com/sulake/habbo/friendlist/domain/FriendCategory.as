package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_229.length / const_390);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_984 * const_390;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_984 + 1) * const_390,this.var_229.length);
      }
