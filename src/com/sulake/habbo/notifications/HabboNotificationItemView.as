package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_531:int = 70;
      
      public static const const_1699:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_549:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1948 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1948 = 15;
         }
         this.var_1947 = this._window.height;
         this.var_1542 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_549:
               ...
               _loc2_ = Number(this.var_1255) / Number(this.var_1012["time_fade_in"]);
               if(this.var_1255 > int(this.var_1012["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1065:
               ...
               if(this.var_1541 > int(this.var_1012["time_display"]) && !this.var_1949)
               {
                  this.startFadeOut();
               }
               break;
            case const_1064:
               ...
               _loc3_ = 1 - Number(this.var_1256) / Number(this.var_1012["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1256 > int(this.var_1012["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(this._window.height < this.var_1947)
         {
            this._window.height = this.var_1947;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1699;
         this._window.y = this.var_1542;
      }
