package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1580:int = 10;
      
      private static const const_1098:int = 100;
      
      private static const const_1579:int = 20;
       
      
      private var var_139:HabboMessenger;
      
      private var var_2892:IScrollbarWindow;
      
      private var var_2077:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_139 = param1;
         this.var_2077 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this._list = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2892 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1098 + const_1579)
         {
            this.refreshList();
            this.afterResize();
         }
         else
         {
            ...
            this.method_2(true,_loc2_,param1);
            this._list.autoArrangeItems = true;
         }
         this.var_2892.scrollV = 1;
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1580;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_2077.enable();
         }
         else
         {
            this.var_2077.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_561.messages.length - const_1098);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_561.messages.length)
         {
            this.method_2(true,_loc1_,this.var_561.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
            _loc3_ = this.method_2(false,_loc1_,null);
            if(_loc3_)
            {
               break;
            }
      ...
      private function method_2(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_710 || param3.type == Message.const_904 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_139.send(new FollowFriendMessageComposer(this.var_561.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_904)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1224)
         {
            return 4294927974;
         }
