package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1444:int = HabboMusicPrioritiesEnum.const_122;
      ...
      private var var_509:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_785.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_785.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_785)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_928,this.onJukeboxInit);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_249,this.onJukeboxDispose);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_718,this.onSoundMachineInit);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_702,this.onSoundMachineDispose);
         this.var_1183 = new Timer(1000);
         this.var_1183.start();
         this.var_1183.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         ...
         {
            this.var_301[_loc6_] = null;
            this.var_766[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1806)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_448)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_785)
               {
            ...
            if(this.var_258)
            {
               ...
               {
                  _loc3_ = this.var_258.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_928,this.onJukeboxInit);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_249,this.onJukeboxDispose);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_718,this.onSoundMachineInit);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_702,this.onSoundMachineDispose);
            }
      ...
      private function addSongStartRequest(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number) : Boolean
      {
         ...
         this.var_301[param1] = _loc7_;
         this.var_766[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_301[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_766[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_301.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_301[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_258.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      {
         if(this.var_622.getValue(param1) == null)
         {
            this.var_622.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_371.length)
         {
            return this.var_371.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_371.length)
         {
            return this.var_371.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_258.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               {
                  if(_loc5_.indexOf(param1[_loc6_]) != -1 && _loc3_.soundObject != null && _loc3_.id != this.var_1461)
                  {
                     _loc3_.soundObject = null;
                     _loc4_.dispose();
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_301[_loc2_] != null)
            {
               _loc3_ = this.var_301[_loc2_];
               _loc4_ = this.var_258.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_765));
         Logger.log("Requested song info\'s : " + this.var_765);
         this.var_765 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_258.add(_loc6_.id,_loc10_);
               ...
               while(this.var_764.indexOf(_loc6_.id) != -1)
               {
                  this.var_764.splice(this.var_764.indexOf(_loc6_.id),1);
                  if(this.var_764.length == 0)
                  {
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1806 = this.getSongRequestCountAtPriority(param1);
         this.var_1461 = param2;
         if(this._priorityPlaying <= const_1444)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2504 != param1.id || _loc3_ > this.var_2503 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2504 = param1.id;
            this.var_2503 = _loc3_;
         }
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_371.add(_loc5_,_loc6_);
            if(this.var_258.getValue(_loc6_) == null)
            {
               this.var_764.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_509 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_80,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_509 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
