package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_223 = param2;
         this.var_785 = [];
         this.var_785.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_785.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_785)
         {
         ...
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_825,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_989,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_825,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_989,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_424 = -1;
         this.var_605 = false;
         this.var_223.stop(HabboMusicPrioritiesEnum.const_122);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_223.playSong(param1,HabboMusicPrioritiesEnum.const_122,_loc3_,0,0,0))
         {
