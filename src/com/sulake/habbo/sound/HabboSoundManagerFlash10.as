package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1578:int = 60;
      
      private static const const_1576:int = 25165823;
      
      private static const const_1577:int = 16777215;
      ...
      private var var_1058:IHabboNotifications;
      
      private var var_557:Number = 1.0;
      ...
      private var var_1592:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         this.var_1311 = new Map();
         this.var_1592 = new ByteArray();
         ...
         events.addEventListener(TraxSongLoadEvent.const_776,this.onTraxLoadComplete);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1058)
         {
            this.var_1058.release(new IIDHabboNotifications());
            this.var_1058 = null;
         }
         super.dispose();
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1057.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1136:
               ...
               case HabboSoundTypesEnum.const_1138:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1757:
            ...
            this.var_1057.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_557;
         _loc2_.play();
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1311.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1058.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1058 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_181 == null || this._connection == null || this._roomEngine == null || this.var_223 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1665,this.var_849));
         this.var_849 = -1;
         this.var_850 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_557 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_557 * 100)));
         }
      }
      ...
      {
         this.var_557 = param1;
         this.var_223.updateVolume(this.var_557);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.SOUNDS);
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_686.getValue(param1) != null)
         {
            ...
            if(this.var_281.getValue(_loc2_) == null)
            {
               ...
               param1.extract(this.var_1592,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1592,_loc2_,TraxSample.const_1618,TraxSample.const_1858);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1312.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1578 && this.var_1312.length > 0)
            {
               _loc3_ = this.var_1312.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_686.length == 0 && this.var_849 != -1)
            {
               this.var_850.ready = true;
               _loc4_ = this.var_849;
               this.var_849 = -1;
               this.var_850 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_776,_loc4_));
               if(this.var_2880)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_850 == null && this.var_1311.length > 0)
         {
            _loc1_ = this.var_1311.getKey(0);
            _loc2_ = this.var_1311.remove(_loc1_);
            if(_loc2_ != null)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_776,_loc1_));
               }
               else
               {
                  this.var_850 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1576)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1577 && _loc9_ < _loc2_.length)
            {
