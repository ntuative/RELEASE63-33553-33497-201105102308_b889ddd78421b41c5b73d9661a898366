package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1490:String = "Default";
      
      private static const const_1489:int = 2;
      
      private static const const_1491:String = AvatarSetType.const_35;
      ...
      protected var var_1079:Boolean;
      ...
      protected var var_645:AvatarFigureContainer;
      ...
      private var var_972:IActiveActionData;
      ...
      private var var_2875:String = null;
      
      private var var_2873:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1491,const_1489);
         this.var_337 = new Array();
         this.var_972 = new ActiveActionData(AvatarAction.const_376);
         this.var_972.definition = this._structure.getActionDefinition(const_1490);
         this.resetActions();
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param2 < AvatarDirectionAngle.const_1270)
         {
            param2 = AvatarDirectionAngle.const_324 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_324)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_683,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_280.length == 1 && this.var_89 == this.var_1664)
         {
            return this.var_89 + this.var_556 + this.var_683 % 4;
         }
         if(this.var_280.length == 2)
         {
            for each(_loc1_ in this.var_280)
            {
               ...
               {
                  return this.var_89 + this.var_556 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_683 % 11;
                  return this.var_89 + "_" + this.var_1664 + this.var_556 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2874 || param2 != this.var_2875 || param1 != this.var_2873)
         {
            this.var_2874 = param3;
            this.var_2875 = param2;
            this.var_2873 = param1;
            this.var_2067 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1342 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1342)
            {
               this.var_46.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_683);
         ...
         if(this.var_573 != null)
         {
            if(this.var_573.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_573.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_683);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_337.push(new ActiveActionData(param1,param2,this.var_683));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_286 = this.var_972;
         this.var_286.definition = this.var_972.definition;
         this.resetBodyPartCache(this.var_972);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_556 = "";
         this.var_280 = this._structure.sortActions(this.var_337);
         if(this.var_280 == null)
         {
            this.var_733 = new Array(0,0,0);
            if(this.var_1591 != "")
            {
               _loc1_ = true;
               this.var_1591 = "";
         ...
         {
            this.var_733 = this._structure.getCanvasOffsets(this.var_280,this._scale,this.var_89);
            for each(_loc4_ in this.var_280)
            {
               this.var_556 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_342)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1590 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1591 != this.var_556)
            {
               _loc1_ = true;
               this.var_1591 = this.var_556;
            }
         }
         this.var_1490 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_280)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_956 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_364 || _loc1_.actionType == AvatarAction.const_256 || _loc1_.actionType == AvatarAction.const_424)
               {
                  this.var_956 = true;
               }
            }
