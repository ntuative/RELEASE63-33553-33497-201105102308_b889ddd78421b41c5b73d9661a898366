   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.const_297,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.const_283,_windowManager,_assetLibrary);
         }
         else
         {
