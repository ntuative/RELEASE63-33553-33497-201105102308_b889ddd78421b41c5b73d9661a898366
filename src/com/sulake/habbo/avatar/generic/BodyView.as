package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_648:String = "tab_boy";
      
      private const const_649:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_65.controller.gender)
         {
            case FigureData.const_82:
               activateTab(this.const_648);
               inactivateTab(this.const_649);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_649);
               inactivateTab(this.const_648);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_648:
                  var_65.controller.gender = FigureData.const_82;
