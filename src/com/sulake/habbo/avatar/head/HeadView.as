   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.const_207,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.const_284,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.const_278,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.const_292,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_65,FigureData.const_296,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_65 && var_150 == "")
         {
            var_65.switchCategory(FigureData.const_207);
         }
      }
