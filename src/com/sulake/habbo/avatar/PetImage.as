   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_683);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_683);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_683);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_683);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_972);
         this.getCache().resetBodyPartCache(this.var_972);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1491 = this._structure.sortActions(this.var_337);
         ...
         {
            this.var_733 = this._structure.getCanvasOffsets(this.var_1491,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1491)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_424)
               {
                  this.var_956 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_364)
               {
                  this.var_956 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1161 = _loc4_.id;
                     this.var_1767 = _loc4_.breed;
                     break;
                  }
               }
            }
