package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1787 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2472 = parseInt(_loc2_,16);
         this.var_2471 = parseInt(_loc3_,16);
         ...
         this.var_707 = new ColorTransform(this.var_2013,this.var_2015,this.var_2014,this._alphaMultiplier);
         this.var_1171 = this.generatePaletteMapForGrayscale(this.var_2471,this.var_2472);
      }
      ...
      {
         return this.var_1171.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1171.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1171.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1171.getValue("alphas") as Array;
      }
