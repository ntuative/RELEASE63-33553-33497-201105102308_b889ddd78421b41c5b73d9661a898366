package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_742:IFigurePartSet;
      ...
      private const const_1555:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_705 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1739 = Math.max(this.var_1739,_loc6_.colorLayerIndex);
            }
         }
         this.var_423 = this.var_65.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_705 != null && !this.var_1741)
            {
               _loc3_ = this.var_705;
            }
            else
            ...
            if(this.var_742)
            {
               switch(this.var_742.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc2_.style = HabboIconType.const_827;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1308.color = this.const_1554;
         }
         else
         {
            this.var_1308.color = this.const_1555;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_370[_loc6_] + "_" + FigureData.const_171;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1741 && _loc2_.colorLayerIndex > 0)
               {
