package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_644 = _loc4_.content as BitmapData;
         ...
         this.var_880 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_644.width,this.var_644.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_644,this.var_644.rect,new Point(0,0));
         }
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_880.width,this.var_880.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_880,this.var_880.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_879)
            {
               switch(this.var_879.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc4_.style = HabboIconType.const_827;
                     _loc4_.visible = true;
               }
            }
            else
