package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1600:IWindowContainer;
      
      public static var var_2109:int = 6710886;
      ...
      private var var_396:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_551:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1299 = [];
         this.var_1468 = [AvatarEditorFigureCategory.const_813,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_269,AvatarEditorFigureCategory.const_975,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_110];
         super();
         ...
         if(var_1318 == null)
         {
            ...
            var_1318 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1600 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1600 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_467 = new Timer(1000);
         this.var_467.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1468;
         }
         for each(_loc6_ in param4)
         {
            this.var_1299.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_467.stop();
            this.var_467.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_467 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1468);
         }
         if(param1.length != this.var_1299.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1299.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2827 = this.canChangeOutfit();
            this.var_467.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_396 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_396.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_396.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1299.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_396.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_396.numSelectables)
               {
                  this.var_396.getSelectableAt(_loc6_).x = this.var_396.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_396.setSelected(this.var_396.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1468;
      ...
      public function update() : void
      {
         ...
         {
            _loc3_.visible = this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_46) && this._controller.isWardrobeAllowed();
         }
         var _loc4_:String = "null";
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_46) && (this.var_2041 == AvatarEditorSideCategory.const_110 || this.var_2828))
         {
      ...
      {
         if(this.var_2041 == AvatarEditorSideCategory.const_110)
         {
            this.var_2828 = false;
            this.setSideContent(AvatarEditorSideCategory.const_879);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_879:
               break;
            case AvatarEditorSideCategory.const_625:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_625);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_400 = param1;
         this.var_396.setSelected(this.var_396.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2656 = new Date().valueOf();
                  this.var_2827 = false;
                  this.var_467.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_551)
         {
            ...
            this.var_551 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_551.procedure = this.stripClubDialogEventProc;
            this.var_551.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2656 > 5000;
      }
   }
}
