package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1567:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1566:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1298:AvatarEditorHandler;
      ...
      private var var_1578:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_998 = FigureData.const_82;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_193)
         {
            ...
            _loc2_.loadAvatarData(const_1567,FigureData.const_82);
            _loc3_.loadAvatarData(const_1566,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_549 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_813,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_269,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_975,new LegsModel(this));
            ...
            this.var_549.add(AvatarEditorSideCategory.const_110,new WardrobeModel(this));
            this.var_549.add(AvatarEditorSideCategory.const_625,new ClubPromoModel(this));
            this.var_193 = true;
         }
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_275 == null)
            {
               this.var_275 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_813);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_549.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_550 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_1045 = this.var_550.getFigureData(AvatarType.const_125);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1298 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_671[this.var_998];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1578 != null)
         {
            ...
            this.var_1578.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1297 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1568)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1600.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_550.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_550.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1318.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1747)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1297 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1318.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1297 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_549.getValue(AvatarEditorSideCategory.const_110);
      }
