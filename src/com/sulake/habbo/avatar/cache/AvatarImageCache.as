package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1941:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1433:IAvatarImage;
      ...
      private var var_2613:ByteArray;
      
      private var var_2612:ImageData;
      
      private var var_1040:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_786 == GeometryType.const_1263 && param1 == GeometryType.const_1254 || this.var_786 == GeometryType.const_1254 && param1 == GeometryType.const_1263)
         {
            this.var_786 = param1;
            this.var_83 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_378.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_980)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_534)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1433.getFigure(),_loc5_,this.var_786,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_420 == null)
         {
            ...
            this.var_420 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_378);
            if(this.var_420 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_83)
         {
            this.var_83 = this._structure.getCanvas(this._scale,this.var_786);
            if(!this.var_83)
            {
               return null;
            }
            this.var_2614 = new Point(0,this.var_83.height - int(this.var_83.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1689[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_932 || _loc10_ == AvatarAction.const_424;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1498 = this.var_118.bodyPartId;
               this.var_185 = this.var_118.partType;
               this.var_1869 = this.var_118.partId;
               ...
               this.var_1497 = this._scale + "_" + this.var_118.action.assetPartDefinition + "_" + this.var_185 + "_" + this.var_1869 + "_" + _loc5_ + "_" + this._frame;
               this.var_438 = this._assets.getAssetByName(this.var_1497) as BitmapDataAsset;
               if(this.var_438 == null)
               {
                  this.var_1497 = this._scale + "_std_" + this.var_185 + "_" + this.var_1869 + "_" + _loc5_ + "_0";
                  this.var_438 = this._assets.getAssetByName(this.var_1497) as BitmapDataAsset;
               }
               if(!(!this.var_438 || !this.var_438.content))
               {
                  ...
                  {
                     this.var_1040 = this._structure.renderManager.paletteManager.getPalette(this.var_118.paletteMapId);
                     if(this.var_1040 != null)
                     {
                        this.var_974 = this.var_438.content as BitmapData;
                        this.var_184 = new BitmapData(this.var_974.width,this.var_974.height);
                        this.var_2613 = this.var_1040.colorize(this.var_974.getPixels(this.var_974.rect));
                        this.var_184.setPixels(this.var_184.rect,this.var_2613);
                     }
                     else
                     {
                        this.var_184 = (this.var_438.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1498 == AvatarBodyPartType.const_269 || this.var_1498 == AvatarBodyPartType.const_1817 || this.var_1498 == AvatarBodyPartType.const_1693) && this.var_118.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  this.var_975 = this.var_438.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2612 = new ImageData(this.var_184,this.var_975,_loc7_);
                  this.var_976.push(this.var_2612);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_976,_loc6_);
         ...
         _loc8_ = this.var_976.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_976.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
