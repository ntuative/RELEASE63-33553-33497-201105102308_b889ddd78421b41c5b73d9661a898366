package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1363,const_1362,2,2),null,0) as IWindowContainer;
         ...
         this.var_273 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_273.numTabItems)
         {
            _loc6_ = this.var_273.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1528 = _loc2_.light;
         if(this.var_446 != null)
         {
            this.var_446.setValue(this.var_1528);
         }
         this.var_535 = this.colors.indexOf(_loc2_.color);
         if(this.var_646 != null)
         {
            this.var_646.setSelectedColorIndex(this.var_535);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_273.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_273.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_273.selector.getSelected();
         return this.var_273.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1529 = XML(_loc1_.content);
         return this.var_1529;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_446 != null)
         {
            this.var_446.min = this._widget.minLights[param1 - 1];
         }
      }
