package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_999:String = "welcome_gift_email_verified";
      
      private const const_1370:String = "welcome_gift_email_change";
      
      private const const_2177:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1094)
         {
            this.setViewState(this.const_999);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_651:
               ...
               this._view.findChildByName("edit_text").visible = this.var_882;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_882);
               break;
            case this.const_999:
            ...
            case this.const_1370:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_882);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1356;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1370);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_823,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1094 ? this.const_999 : this.const_651);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1357 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1357));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_597,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_986,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_597,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_986,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_597:
               this.var_1356 = param1.email;
               this.var_1094 = param1.isVerified;
               this.var_882 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1356 = this.var_1357;
            this.setViewState(this.const_651);
         }
         else
         {
            if(param1.result == this.const_2177)
            {
               this.var_882 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1357);
