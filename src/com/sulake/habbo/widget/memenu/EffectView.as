package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2182:int = 1000;
      ...
      {
         super();
         this.var_213 = new Timer(this.const_2182);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_177.isActive)
         {
            ...
            this.var_902.width = _loc2_ * this.var_313;
         }
         else
         {
            this.var_902.width = 0;
            this.var_213.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_722 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_722 == null)
            {
               return;
            }
         ...
         if(!this.var_177.isActive)
         {
            this.var_722.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_722.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_722.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_903 = this._window.findChildByName("effect_hilite");
            this.var_903.visible = false;
         }
         this.setTimeLeft();
         this.var_902 = this._window.findChildByName("loader_bar");
         if(this.var_902 != null)
         {
            this.var_313 = this.var_902.width;
            this.var_213.start();
            this.onUpdate();
         }
