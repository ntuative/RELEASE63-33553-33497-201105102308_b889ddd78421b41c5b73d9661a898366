package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1531:int = 25;
      ...
      protected var var_2134:FixedSizeStack;
      
      protected var var_2135:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2134 = new FixedSizeStack(const_1531);
         super();
         this._widget = param1;
      }
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1609 = param5;
         param1.var_2217 = param4;
         param1.var_2136 = param6;
         param1.updateWindow();
      }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_938));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1338)
         {
            ...
            if(this.var_1609 == RoomObjectTypeEnum.const_167 || this.var_1609 == RoomObjectTypeEnum.const_587)
            {
            ...
            this.var_2134.addValue(_loc5_);
            _loc6_ = this.var_2134.getMax();
            if(_loc6_ < this.var_2135 - const_1066)
            {
               _loc6_ = this.var_2135 - const_1066;
            }
