package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1340:uint = 0;
      
      protected static const const_367:uint = 1;
      
      protected static const const_990:uint = 2;
      
      protected static var var_1344:uint = const_367;
      
      private static const const_1357:uint = 4281149991;
      
      private static const const_1358:uint = 4283715916;
      
      private static const const_1360:uint = 16777215;
      
      private static const const_1361:uint = 9552639;
      
      private static const const_1356:uint = 16744755;
      
      private static const const_1359:uint = 16756591;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_334:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1323)
         {
            ...
            {
               this.var_334 = const_990;
            }
            else
            {
               this.var_334 = var_1344;
            }
         }
         if(this.var_334 == const_1340)
         {
         ...
         if(this.var_334 == const_1340 || this.var_334 == const_367)
         {
            ...
            else
            {
               ...
               this.var_334 = const_367;
            }
         }
         if(this.var_334 == const_367)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = const_1358;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1361;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1359;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == "button")
            {
               param2.color = const_1357;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1360;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
