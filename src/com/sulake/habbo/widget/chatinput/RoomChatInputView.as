package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_1769:IWindow;
      
      private var _button:IWindow;
      
      private var var_1768:IWindow;
      ...
      private const const_2196:int = 250;
      
      private const const_2198:int = 0;
      
      private const const_2197:String = "${widgets.chatinput.say}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1162 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2440 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_1769 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1768 = this._window.findChildByName("send_button_text");
         this.var_1444 = this._window.findChildByName("block_text");
         this.var_1768.caption = this.const_2197;
         this.var_24.setParamFlag(HabboWindowParam.const_41,true);
         this.var_24.addEventListener(WindowMouseEvent.const_44,this.windowMouseEventProcessor);
         this.var_24.addEventListener(WindowKeyboardEvent.const_191,this.windowKeyEventProcessor);
         this.var_24.addEventListener(WindowKeyboardEvent.const_305,this.keyUpHandler);
         ...
         this.var_1442 = true;
         this.var_534 = "";
         this._window.addEventListener(WindowEvent.const_842,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_559,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1769.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2196 - _loc3_;
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_24 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1162 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_24.text = "";
                  this.var_534 = "";
               }
