package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_416 && param1.songId == this.var_1753)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_240 = var_45.findChildByTag("catalog");
         if(var_240 != null)
         {
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_447.length,param1.length);
