package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2178:int = 5;
      ...
      private var var_1098:Rectangle = null;
      
      private var var_2926:int = 0;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1099 = 0;
         this.var_1098 = param2.rectangle.clone();
         this.var_1098.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1098.width)
         {
            return false;
         }
         if(this.var_1099 + param1.height > this.var_1098.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1098.width)
         {
            this._offsetX = 0;
            this.var_1099 += param1.height + this.const_2178;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1099);
         this._offsetX += param1.width + this.const_2179;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1360 != null && this.var_1360.indexOf(param1) != -1)
         {
