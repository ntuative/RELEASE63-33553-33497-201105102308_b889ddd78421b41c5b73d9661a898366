package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1414:int = 152;
      
      private static const const_1417:int = 16;
      
      private static const const_662:int = 4;
      
      private static const const_1407:uint = 14342874;
      
      private static const const_1415:uint = 3815994;
      
      private static const const_1412:uint = 2085362;
      
      private static const const_1408:uint = 39616;
      
      private static const const_1411:uint = 10513106;
      
      private static const const_1413:uint = 8734654;
      
      private static const const_1416:uint = 9094430;
      
      private static const const_1405:uint = 6200576;
      
      private static const const_1418:String = "happiness";
      
      private static const const_1409:String = "experience";
      
      private static const const_1406:String = "energy";
      
      private static const const_1410:int = 250;
      
      private static const const_1029:int = 25;
      ...
      private var var_199:PetCommandTool;
      ...
      {
         if(this.var_51 == null || this.var_45 == null || this.var_96 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_45.width,this.var_96.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_45.width < this.var_96.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1418,param1.nutrition,param1.nutritionMax,const_1408,const_1412);
         this.updateStateElement(const_1409,param1.experience,param1.experienceMax,const_1413,const_1411);
         this.updateStateElement(const_1406,param1.energy,param1.energyMax,const_1405,const_1416);
         ...
         this.updateWindow();
         this.var_542 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_199 && this.var_199.isVisible() && param1.isOwnPet)
         {
            this.var_199.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_199.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1414,const_1417,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1407);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1415);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_662,_loc7_.width - 2,_loc7_.height - 2 - const_662);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_662);
      ...
      private function openTrainView() : void
      {
         if(this.var_199 == null)
         {
            this.var_199 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_542) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_199.showWindow(true);
            this.var_199.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_199 && this.var_199.getPetId() == this.var_542)
               {
                  this.var_199.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1700,true);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1029 + const_1028;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1028;
            }
         }
         this.var_96.height = _loc4_ + const_1029;
         this.updateWindow();
      }
   }
}
