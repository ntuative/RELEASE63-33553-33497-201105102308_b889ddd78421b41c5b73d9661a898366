package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1482:Point = new Point(100,30);
      ...
      private var var_462:IFrameWindow;
      ...
      private const const_2214:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_393 = new Timer(this.const_2214);
         this.var_393.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1291.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_542);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1291.getValue(this.var_542) as CommandConfiguration;
      ...
      {
         this.var_1291.remove(param1);
         this.var_1291.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_751,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.context.getDesktopWindow().addEventListener(WindowEvent.const_43,this.onWindowDesktopResized);
         this.var_41.procedure = this.onCommandWindowProcedure;
         this.var_41.position = const_1482;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_462 == null)
         {
            ...
            this.var_462 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_462 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_462.x = 200;
            this.var_462.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_440,this.var_542));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_602,this.var_542,this.var_2001 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_602,this.var_542,this.var_2001 + " " + _loc5_);
