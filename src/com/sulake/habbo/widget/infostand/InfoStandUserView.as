package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1167:TagListRenderer;
      
      private var var_141:IBorderWindow;
      
      private var var_2690:int;
      
      private var var_2689:Boolean = true;
      
      private const const_1063:int = 5;
      
      private const const_1947:int = 7829367;
      
      private const const_1948:int = 16777215;
      
      private const const_2213:int = 2000;
      
      private const const_2212:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1167 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2689 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_141.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_141.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_141.x = _loc5_.left - this.var_141.width;
         this.var_141.y = _loc5_.top + (_loc5_.height - this.var_141.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_141.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_141.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_141.x = _loc7_.left - this.var_141.width;
         this.var_141.y = _loc7_.top + (_loc7_.height - this.var_141.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_141 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_141 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1063;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1947;
            }
            else
            {
               _loc3_.textColor = this.const_1948;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1063,this.const_2212);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_305,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_305,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1167.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_140);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_771:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_760:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2690 > this.const_2213 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2690 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1947;
         }
      }
