package com.sulake.habbo.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_2220:int = 0;
      
      private const const_1956:int = 1;
      ...
      override public function get state() : int
      {
         ...
         {
            return this.const_1956;
         }
         return this.const_2220;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_786,this.onChooserContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_786,this.onChooserContent);
