package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_179.state = RoomChatHistoryPulldown.const_246;
         ...
         this.var_48 = param2.createWindow("chatscroller","",HabboWindowType.const_1163,HabboWindowStyle.const_45,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_179.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_246);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_179.state == RoomChatHistoryPulldown.const_379 || this.var_179.state == RoomChatHistoryPulldown.const_549;
      }
      ...
      {
         if(!this.var_421 && !this.var_1616)
         {
            this.var_421 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_179.state = RoomChatHistoryPulldown.const_379;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_48 != null)
         {
            ...
            if(param2)
            {
               this.var_48.scrollV = this.var_597;
            }
         }
         if(this.var_179 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_422 > 0 && param2)
         {
            if(this.var_1719)
            {
               if(Math.abs(param1 - this.var_422) <= const_1117)
               {
                  return;
               }
               this.var_1719 = false;
            ...
            if(this.var_421)
            {
               ...
               _loc5_ = (param1 - this.var_422) / this.var_48.height;
               _loc3_ = this.var_597 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_422;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_48.scrollV < 1 - const_1395 / this.var_48.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_48 != null)
         {
            this.var_597 = this.var_48.scrollV;
         }
         if(this.var_48 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_597 - this.var_48.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
