package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1064:int = 3;
      ...
      private var var_2776:BitmapData;
      ...
      private var var_2778:BitmapData;
      
      private var var_2777:BitmapData;
      
      private var var_2781:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2776 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1999 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2780 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1997 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1998 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2778 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2777 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_77 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_361,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_87),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_77);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_40.height - const_87,param3.width,const_87),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_526,HabboWindowStyle.const_45,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_87),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_549:
               this.var_77.blend += param1 / const_1086;
               ...
               break;
            case const_1064:
               this.var_77.blend -= param1 / const_1087;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_40.height - const_87;
            this._window.width = this.var_40.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_40.height - const_87;
            this._region.width = this.var_40.width - this.var_2781;
         }
         if(this.var_77 != null)
         {
            this.var_77.rectangle = this.var_40.rectangle;
            this.var_77.height -= const_87;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2779 == this._window.width)
         {
            return;
         }
         this.var_2779 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2780;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1997;
            barX.disposesBitmap = false;
            this.var_2781 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.method_5(this.var_2776,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.method_5(this.var_1999,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.method_5(this.var_1999,destGripRBitmap);
         ...
         this.var_77.bitmap = this.var_2777;
         this.var_77.disposesBitmap = false;
      }
      
      private function method_5(param1:BitmapData, param2:BitmapData) : void
      {
