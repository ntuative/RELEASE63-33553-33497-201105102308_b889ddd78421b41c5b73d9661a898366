package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_811:String = "MISV_BUY_MORE";
      
      public static const const_731:String = "MISV_PREVIEW_PLAYING";
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2021.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_731,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_811,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_453.add(const_731,_loc1_);
            this.var_2020 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2021 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_638));
         ...
         if(_loc1_ != null)
         {
            this.var_453.add(const_811,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_486));
         }
      }
