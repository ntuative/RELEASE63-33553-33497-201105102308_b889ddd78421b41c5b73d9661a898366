package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1317:String = "PLSV_START_PLAYBACK";
      
      public static const const_551:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_551)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_453[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_453[const_888];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_453.add(const_551,_loc1_);
