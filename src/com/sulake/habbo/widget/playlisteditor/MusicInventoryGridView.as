package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_668:IItemGridWindow;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_668.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         if(this.var_99 != null)
         {
            this.var_99.playButtonState = MusicInventoryGridItem.const_1264;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_99 != null)
         {
            this.var_99.playButtonState = MusicInventoryGridItem.const_481;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_164;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_99.playButtonState == MusicInventoryGridItem.const_481)
               {
                  this.var_99.playButtonState = MusicInventoryGridItem.const_1227;
                  this._widget.method_10(this.var_99.songId);
               }
               else
               {
                  this.stopPreview();
            ...
            {
               _loc4_ = this.var_668.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
