package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1482:Point = new Point(3,3);
      
      private static const const_1512:uint = 7433577;
      
      private static const const_1511:uint = 5723213;
      
      private static const const_461:String = "_hover";
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1482;
         ...
         param6.addEventListener(HabboToolbarEvent.const_326,this.onToolbarStateEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._events)
         {
            ...
            this._events.removeEventListener(HabboToolbarEvent.const_326,this.onToolbarStateEvent);
            this._events = null;
         }
         if(this._catalog != null)
         {
      ...
      private function onToolbarStateEvent(param1:HabboToolbarEvent) : void
      {
         switch(param1.type)
         {
            case HabboToolbarEvent.const_303:
               ...
               this.iconVisibility("INVENTORY",false);
               break;
            case HabboToolbarEvent.const_326:
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_461 ? this.var_1511 : this.var_1512;
         }
         else
         {
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1512 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1511)
         {
            this.var_1511.dispose();
         }
         this.var_1511 = this.addShadow(param1,new Point(4,5),4281150249);
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_990.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1041;
            _loc2_.y = const_1041;
            this.var_990.add(param1,_loc2_);
         }
         return _loc2_;
      }
   }
