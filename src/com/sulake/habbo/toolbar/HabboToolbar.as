package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1409:LogoutController;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_274.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_274 && this._windowManager && this._config)
         {
            this.var_274.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1409 = new LogoutController(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1214,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1176,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1256,this.onHideWindowEvent);
         this.var_193 = true;
      ...
      {
         if(this._view != null && this.var_193)
         {
