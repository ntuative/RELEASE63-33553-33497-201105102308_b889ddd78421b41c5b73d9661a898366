   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_167)
            {
               this.var_21.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2730 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_21.tellUI(HabboHelpViewEnum.const_943);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         this.var_21.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + this.method_8(_loc3_.closeReason) + "}",0,this.onAlertClose);
      }
      
      private function method_8(param1:int) : String
      {
         if(param1 == 1)
         {
            return "useless";
      ...
      {
         this.var_21.showUI(HabboHelpViewEnum.const_403);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showUI(HabboHelpViewEnum.const_472);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_21.tellUI(HabboHelpViewEnum.const_242,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showUI(HabboHelpViewEnum.const_1230);
         this.var_21.tellUI(HabboHelpViewEnum.const_1230,_loc5_);
      }
