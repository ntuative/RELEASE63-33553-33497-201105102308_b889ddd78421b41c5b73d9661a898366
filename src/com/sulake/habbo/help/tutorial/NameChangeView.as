package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1436:uint = 13232628;
      ...
      private var var_1159:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_366;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_500 = param1;
         if(this.var_1760 == this.var_500)
         {
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_500);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1068 || param1 == ChangeUserNameResultMessageEvent.var_1067)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1159 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1159.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1436;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_500 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_500);
               break;
