package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1092:uint = 4284532064;
      
      private static const const_1091:uint = 2577770;
      ...
      private var var_672:ItemPopupCtrl;
      ...
      private var var_2048:IWindowContainer;
      
      private var var_213:Timer;
      
      private var var_1048:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_672 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2048 = this.createMinimizedWindow();
         }
         if(!this.var_2831)
         {
            return this.var_68;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_68)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.ownUserAccepts ? uint(const_1092) : uint(const_1091);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.otherUserAccepts ? uint(const_1092) : uint(const_1091);
            }
         ...
         if(this.var_68)
         {
            ...
            switch(this.var_17.state)
            {
               ...
               case TradingModel.const_432:
                  ...
                  break;
               case TradingModel.const_337:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_642:
                  _loc1_.disable();
      ...
      public function removeSelection() : void
      {
         if(this.var_1048)
         {
            this.var_1048.isSelected = false;
            this.var_1048 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1783)
            {
            ...
            this.var_672.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_606);
            this.var_672.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_672.hideDelayed();
         }
      }
         ...
         if(this.var_190.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_17.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_17.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_672.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_606);
               }
            }
            else
            {
