package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1631:uint = 9;
      ...
      public static const const_642:uint = 4;
      ...
      public function TradingModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboSoundManager)
      {
         ...
         this.var_53 = new TradingView(this,param2,param4,param5,param6,param7);
      }
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_53.updateItemList(this.var_725);
         this.var_53.updateItemList(this.var_1393);
      ...
      public function close() : void
      {
         if(this.var_838)
         {
            if(this._state != const_230 && this._state != const_263)
            {
      ...
      {
         this.var_53.setMinimized(param1 != InventoryCategory.const_83);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_726 + " OTHER: " + this.var_1137);
         ...
         {
            case const_230:
               if(param1 == const_200 || param1 == const_263)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_249.length)
         {
            _loc2_ = this.var_249.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_53.alertPopup(TradingView.const_1335);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_725)
            {
               this.var_726 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1137 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_53.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_725)
            {
               this.var_53.alertPopup(TradingView.const_1123);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_249.length < const_1631)
         {
