package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this._badgeRefreshTimer = new Timer(1000,1);
         this._badgeRefreshTimer.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_392.events.addEventListener(BadgeImageReadyEvent.const_118,this.onBadgeImageReady);
      }
      ...
      public function updateList() : void
      {
         ...
         while(true)
         {
            ...
            {
               this.method_2(true,_loc2_,_loc1_[_loc2_]);
            }
            else
            {
               _loc3_ = this.method_2(false,_loc2_,null);
               if(_loc3_)
               {
                  break;
               }
      ...
      private function method_2(param1:Boolean, param2:int, param3:AchievementData) : Boolean
      {
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:String = "inventory.achievements.entrydetails." + param2.method_3;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this._badgeRefreshTimer.running);
