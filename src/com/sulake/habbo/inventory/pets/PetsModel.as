   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this._controller.toggleInventoryPage(InventoryCategory.const_83,param2);
         }
         this.resetUnseenItems(UnseenItemCategoryEnum.const_53);
      }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1819 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_33,RoomObjectTypeEnum.const_225,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1819 && param1.type == RoomEngineObjectEvent.const_157)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_514.indexOf(_loc2_) == -1)
            {
               this.var_514.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      {
         if(param1 != UnseenItemCategoryEnum.const_53 || !this._controller.isMainViewActive)
         {
            return;
         }
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_514 && this.var_514.length > 0)
         {
      ...
      {
         return this.var_514.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_514.indexOf(param1) > -1;
      }
   }
}
