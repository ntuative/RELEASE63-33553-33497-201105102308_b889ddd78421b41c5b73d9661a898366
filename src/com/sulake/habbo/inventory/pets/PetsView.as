package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      {
         var _loc2_:PetsGridItem = this.var_487.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_487 == null || this.var_487.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_487.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_487.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_65.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_253.addGridItem(_loc2_.window);
            this.var_487.add(param1.id,_loc2_);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_65.switchToFurnitureCategory(FurniModel.const_42);
                  break;
               case "tab_wall":
      ...
      public function updateState() : void
      {
         ...
         if(!this.var_65.isListInitialized())
         {
