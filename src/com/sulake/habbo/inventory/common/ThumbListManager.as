package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1581:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_94 = this.var_675.height;
         this.var_1303 = param5;
         this.var_1050 = param6;
         this.var_237 = Math.floor(this.var_1303 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1303,this.var_1050);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_237 * this._thumbWidth,this.var_1303),Math.max(this.var_674 * this.var_94,this.var_1050),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_237 && this.var_26.height < _loc3_.y * this.var_94)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_237 - 1),this.var_94);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_237 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_94),null,null,true);
         _loc4_ = new Rectangle(0,this.var_94,this._thumbWidth * (this.var_237 - 1),this.var_26.height - this.var_94);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1581.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_1050)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_1050);
