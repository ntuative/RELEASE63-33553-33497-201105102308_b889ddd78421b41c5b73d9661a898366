package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2221:int = 0;
      
      private const const_1031:int = 1;
      
      private const const_1902:int = 2;
      
      private const const_1903:int = 3;
      
      private const const_1938:int = 42;
      
      private const const_1939:int = 120;
      ...
      private var var_754:MarketplaceModel;
      ...
      private function resetUnseenItemCategory(param1:String) : void
      {
         ...
         {
            case FurniModel.const_48:
               this.var_65.resetUnseenItems(UnseenItemCategoryEnum.const_897);
               break;
            case FurniModel.const_42:
               this.var_65.resetUnseenItems(UnseenItemCategoryEnum.const_764);
         }
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_433.getValue(this.var_374);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_65.getCategoryContent(this.var_374);
         if(!this.var_65.isListInited())
         {
            _loc2_ = this.const_1031;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1902;
         }
         else
         {
            _loc2_ = this.const_1903;
         }
         if(this.var_2195 == _loc2_)
         {
            return;
         }
         this.var_2195 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_1031:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               break;
            case this.const_1902:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1903:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_65.getGroupItemInIndex(_loc3_,this.var_374);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_754 && this.var_754.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1222)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1939)
         {
            _loc3_ = this.const_1939;
         }
         else if(_loc3_ < this.const_1938)
         {
            _loc3_ = this.const_1938;
         }
         else
         {
