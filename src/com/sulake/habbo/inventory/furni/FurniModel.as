package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1562:int = 1000;
      ...
      private var var_2002:Vector.<Array>;
      
      private var var_2003:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_664 = [];
         this.var_662 = [];
         this.var_663 = new Timer(const_1563,1);
         ...
         this.var_2790 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_157,this.onObjectPlaced);
               }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_42)
            {
               if(this.var_2002 == null)
               {
                  this.var_2002 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2002;
            }
            else
            {
               if(this.var_2003 == null)
               {
                  this.var_2003 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2003;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_1032 == null)
         {
            this.var_1032 = this._windowManager.buildFromXML(this.var_2790) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_1032.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_446);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_661.add(const_42,new Array());
         this.var_661.add(const_48,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_42;
            _loc5_ = this.var_664.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_48;
            _loc5_ = this.var_662.indexOf(param1.ref) > -1;
         }
      ...
      {
         return getTimer() < this.var_2789 + const_1562;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_333;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_335 || _loc3_.category == FurniCategory.const_357 || _loc3_.category == FurniCategory.const_319)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_661.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_979)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_664.indexOf(_loc2_) == -1)
            {
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_662.indexOf(_loc2_) == -1)
            {
               this.var_662.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems(param1:int) : void
      {
         ...
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_764:
               if(this.var_664 && this.var_664.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(param1));
                  this.var_664 = [];
                  _loc3_ = this.getCategoryContent(const_42);
               }
               break;
            case UnseenItemCategoryEnum.const_897:
               if(this.var_662 && this.var_662.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(param1));
                  this.var_662 = [];
      ...
      {
         return this.var_664.length + this.var_662.length;
      }
   }
}
