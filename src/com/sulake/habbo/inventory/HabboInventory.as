package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2176:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         {
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_91,this.roomSessionEventHandler);
            this._roomSessionManager.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_512,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_49.getValue(InventoryCategory.const_83));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_49.getValue(InventorySubCategory.const_333));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_708));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_349));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_49.getValue(InventoryCategory.ACHIEVEMENTS));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_49.getValue(InventoryCategory.const_150));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_49.getValue(InventoryCategory.const_446) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomSessionManager.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
         this._roomSessionManager.events.addEventListener(RoomSessionEvent.const_91,this.roomSessionEventHandler);
         this._roomSessionManager.events.addEventListener(RoomSessionPropertyUpdateEvent.const_512,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_91:
               this.var_1086 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_512:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_392 || !this._config || !this._catalog || !this._avatarRenderer || !this._roomSessionManager || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_49.add(InventoryCategory.const_446,_loc1_);
         ...
         this.var_49.add(InventoryCategory.const_708,_loc4_);
         ...
         this.var_49.add(InventoryCategory.ACHIEVEMENTS,_loc5_);
         ...
         this.var_49.add(InventorySubCategory.const_333,_loc6_);
         ...
         this.var_49.add(InventoryCategory.const_150,_loc8_);
         this.var_193 = true;
         if(this.var_2157)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_333:
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2176);
         }
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2156)
         {
            this.var_2156 = _loc1_;
