package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_872:int = 0;
      
      protected var var_705:BitmapData;
      
      protected var var_2665:int;
      ...
      private const const_1954:Number = 1;
      
      private const const_1955:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2920 == FurniModel.const_42)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1595));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_979)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1955;
               _loc1_.blend = this.const_1955;
            }
            else
            {
               this._window.blend = this.const_1954;
               _loc1_.blend = this.const_1954;
            }
         }
         if(this.isSelected)
         {
            this.var_1308.color = !!this.var_1561 ? uint(const_1556) : uint(const_1554);
         }
         else
         {
            this.var_1308.color = !!this.var_1561 ? uint(const_1553) : uint(const_1555);
         }
         ...
         if(_loc5_)
         {
            if(this.var_2142 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2921;
               _loc5_.visible = true;
            }
            else
            {
