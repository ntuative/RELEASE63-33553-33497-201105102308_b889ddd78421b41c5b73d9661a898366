package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1403:int = 1;
      
      private static const const_1404:int = 2;
      
      private static const const_1923:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1403);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_931.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_931.remove(param1);
         this.var_931.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1404);
      }
