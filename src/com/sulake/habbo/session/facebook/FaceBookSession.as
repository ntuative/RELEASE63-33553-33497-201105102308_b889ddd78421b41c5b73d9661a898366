package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1500:String = "sendAccessTokenToServer";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1500,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1499,this.method_7);
