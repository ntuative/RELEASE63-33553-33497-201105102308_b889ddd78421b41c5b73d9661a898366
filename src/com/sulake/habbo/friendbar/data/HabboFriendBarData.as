package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_673:String = "FriendBar";
      
      private static const const_672:String = "user_interaction";
      
      private static const const_1501:String = "visit_btn_click";
      
      private static const const_1502:String = "chat_btn_click";
      
      private static const const_1505:String = "find_friends_btn_click";
      
      private static const const_1051:String = "Toolbar";
      
      private static const const_1050:String = "open";
      
      private static const const_1049:String = "close";
      
      private static const const_1504:String = "FRIENDLIST";
      
      private static const const_1503:String = "MESSENGER";
       
      
      private var var_87:IHabboCommunicationManager;
      
      private var var_310:IHabboFriendList;
      
      private var var_440:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_310)
            {
               this.var_310.release(new IIDHabboFriendList());
               this.var_310 = null;
            }
            if(this.var_440)
            {
               this.var_440.release(new IIDHabboMessenger());
               this.var_440 = null;
            }
            this.var_137 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_673,const_672,const_1501));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_440)
         {
            this.var_440.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_87)
            {
               this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_673,const_672,const_1502));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_673,const_672,const_1505));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_310)
         {
            if(!this.var_310.disposed)
            {
               if(!this.var_310.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_310.openFriendRequests();
                  }
                  else
                  {
                     this.var_310.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_310.mainWindow;
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1051,const_1504,!!this.var_310.isOpen() ? const_1050 : const_1049));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_440)
         {
            if(!this.var_440.disposed)
            {
               this.var_440.toggleMessenger();
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1051,const_1503,!!this.var_440.isOpen() ? const_1050 : const_1049));
               }
            }
         }
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_137 = !!const_302 ? this.sortByNameAndOnlineStatus(this.var_137) : this.sortByName(this.var_137);
         }
