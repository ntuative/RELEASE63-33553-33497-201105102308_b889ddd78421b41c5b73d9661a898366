package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_771:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2460 = param2.pickerUserId;
         this.var_2532 = param2.pickerUserName;
         this.var_1392 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_771 == null || param1.priority > this.var_771.timeStamp)
         {
            this.var_771 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_771;
         if(_loc1_ == null)
         {
