package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2216:String = "my_issues";
      
      private const const_2215:String = "open_issues";
      
      private const const_2217:String = "picked_issues";
      
      private const const_2223:String = "closed_issues";
      ...
      private var var_394:IIssueBrowserView;
      
      private var var_2026:IIssueBrowserView;
      
      private var var_2025:IIssueBrowserView;
      
      private var var_2027:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_273 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_273.numTabItems)
            {
               _loc5_ = this.var_273.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_273 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_273 == null || this.var_273.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_273.selector.getSelectableByName("open_issues");
         this.var_273.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_394.view.width = this.var_273.container.width;
         this.var_394.view.height = this.var_273.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2216:
               if(this.var_2026 == null)
               {
                  this.var_2026 = new MyIssuesView(this.issueManager,this,this.var_273.container);
               }
               return this.var_2026;
            case this.const_2215:
               if(this.var_2025 == null)
               {
                  this.var_2025 = new OpenIssuesView(this.issueManager,this,this.var_273.container);
               }
               return this.var_2025;
            case this.const_2217:
               if(this.var_2027 == null)
               {
                  this.var_2027 = new PickedIssuesView(this.issueManager,this,this.var_273.container);
               }
