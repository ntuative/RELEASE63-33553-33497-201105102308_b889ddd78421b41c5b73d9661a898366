package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_602 = new IssueBrowser(this,this.var_61.windowManager,this.var_61.assets);
         this.var_1154 = [];
         this.var_1155 = [];
         this.var_924 = new Map();
         this.var_2396 = parseInt(this.var_61.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1735 = new Timer(const_1722,0);
         this.var_1735.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1735.start();
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_602 == null || !this.var_602.isOpen())
         {
            this.var_61.soundManager.playSound(HabboSoundTypesEnum.const_1136);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1593)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_689);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1155.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2396);
            }
         }
