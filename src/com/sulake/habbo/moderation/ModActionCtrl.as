package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1258:IDropMenuWindow;
      
      private var var_528:ITextFieldWindow;
      
      private var _disposed:Boolean;
      
      private var var_647:Boolean = true;
      
      private var var_1014:OffenceCategoryData;
      
      private var var_1013:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1259 = IButtonWindow(this.var_32.getXmlWindow("modact_offence"));
         this.var_1257 = IButtonWindow(this.var_32.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1615;
         ...
         this.var_1258 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1258);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1014 != null;
         if(this.var_1013 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1013.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1014 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1014.offences,this.var_1259,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_32.initMsg.offenceCategories,this.var_1257,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1789;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.connection.send(new ModAlertMessageComposer(this.var_1543,this.var_528.text,this.var_1544));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1014 = this.var_32.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1013 = this.var_1014.offences[_loc3_];
         this.var_528.text = this.var_1013.msg;
         this.var_647 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.connection.send(new ModKickMessageComposer(this.var_1543,this.var_528.text,this.var_1544));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1258.selection < 0)
         {
            this.var_32.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_32.connection.send(new ModBanMessageComposer(this.var_1543,this.var_528.text,this.getBanLength(),this.var_1544));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_647 || this.var_528.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1258.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1259.destroy();
            this.var_1259 = null;
         }
         if(this.var_1257 != null)
         {
            this.var_1257.destroy();
            this.var_1257 = null;
         }
         this.var_1258 = null;
         this.var_528 = null;
