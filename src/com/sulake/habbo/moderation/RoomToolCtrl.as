package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1586:ICheckBoxWindow;
      
      private var var_1587:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_32.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_387));
         Logger.log("BEGINNING TO SHOW: " + this.var_387);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1762;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1081 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1081);
         this.var_1081.procedure = this.onSelectTemplate;
         this.var_1056 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1586 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1587 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_32,WindowTracker.const_810,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1056.isSelected);
         this.var_32.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1788,_loc2_,this.var_528.text,"",""));
         if(this.var_1586.isSelected || this.var_1587.isSelected || this.var_1056.isSelected)
         {
            this.var_32.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1586.isSelected,this.var_1587.isSelected,this.var_1056.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1709);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_32.initMsg.roomMessageTemplates[this.var_1081.selection];
         if(_loc3_ != null)
         {
            this.var_647 = false;
