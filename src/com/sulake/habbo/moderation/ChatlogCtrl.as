package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_916:Array = [];
      
      private static var var_1717:int = 1000;
      
      private static var var_917:Array = [];
      
      private static var var_1716:int = 200;
      ...
      private var var_1635:IMessageComposer;
      ...
      private var var_1715:Dictionary;
      
      private var var_485:Timer;
      
      private var var_1407:Map;
      ...
      {
         this.var_732 = IWindowContainer(this.var_32.getXmlWindow("chatlog_roomheader"));
         this.var_731 = IWindowContainer(this.var_32.getXmlWindow("chatlog_chatline"));
         ...
         this.var_32.connection.send(this.var_1635);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_916.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_731.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_916.length < var_1717)
         {
            ...
            param1.width = this.var_731.width;
            param1.height = this.var_731.height;
            var_916.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_917.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_732.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_917.length < var_1716)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_732.width;
            param1.height = this.var_732.height;
            var_917.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1715[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1407.getValue(param2.chatterName))
            {
               this.var_1407.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1407.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1408)
         {
