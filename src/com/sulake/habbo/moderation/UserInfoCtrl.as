package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1082:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1084) + " mins ago";
         }
         ...
         return Math.round(param1 / const_1082) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1285.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_32.getXmlWindow("user_info"));
            this.var_1285.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_32,WindowTracker.const_1279,this._data.userId),this._callerFrame,this.var_1286,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new RoomVisitsCtrl(this.var_32,this._data.userId),this._callerFrame,this.var_1286,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new SendMsgsCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1544),this._callerFrame,this.var_1286,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ModActionCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1544),this._callerFrame,this.var_1286,false,true);
      }
