package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_918:Array = [];
      
      private static var var_1720:int = 200;
      ...
      {
         this.var_734 = IWindowContainer(this.var_32.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1809;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_918.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_734.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_918.length < var_1720)
         {
            ...
            param1.width = this.var_734.width;
            param1.height = this.var_734.height;
            var_918.push(param1);
         }
         else
         {
