package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_615 != const_1033;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1782 != RecyclerStatusMessageEvent.const_1319;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_615 == const_454;
      }
      ...
      {
         this.var_615 = const_1032;
         this.var_114 = new Array(const_202);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1758:
               this.var_615 = const_454;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1319:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1602:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1198:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1694:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_114.length < const_202)
         {
            return false;
         }
         var _loc1_:int = 0;
