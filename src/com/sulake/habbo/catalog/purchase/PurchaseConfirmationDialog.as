package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2194:int = 10;
      ...
      private const const_1943:uint = 4.293848814E9;
      
      private const const_1942:uint = 4.294967295E9;
      
      private const const_1486:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1708 = _loc1_.stuffTypes;
            this.var_729 = _loc1_.boxTypes;
            this.var_730 = _loc1_.ribbonTypes;
            this.var_1142 = this.var_1708[0];
            this.var_357 = this.var_729[0];
            this.var_359 = this.var_730[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_359 < 0)
         {
            this.var_359 = this.var_730.length - 1;
         }
         if(this.var_359 > this.var_730.length - 1)
         {
            this.var_359 = 0;
         }
         if(this.var_357 < 0)
         {
            this.var_357 = this.var_729.length - 1;
         }
         if(this.var_357 > this.var_729.length - 1)
         {
            this.var_357 = 0;
         }
         var _loc1_:int = this.var_729[this.var_357] * 1000 + this.var_730[this.var_359];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1142,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1400 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1708;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1142);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_729[this.var_357]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_730[this.var_359]);
         this._catalog.purchaseProductAsGift(this.var_1399,this.var_90,this.var_1401,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1399,this.var_90.offerId,this.var_1401);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               for each(_loc7_ in this.var_229)
               {
                  ...
                  if(_loc5_.length >= this.const_2194)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2345 = _loc3_.text;
               break;
            case WindowMouseEvent.const_44:
               ...
               break;
            case WindowKeyboardEvent.const_305:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_594 == null)
         {
            this.var_594 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_594.procedure = this.suggestionsEventHandler;
         }
         if(this.var_252 == null || this.var_594 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_594.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1486;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1943) : uint(this.const_1942);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1142;
               }
            }
            _loc4_++;
         }
