package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1893:String = "ctlg_";
       
      
      protected var var_2121:XML;
      ...
      private var var_1129:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1893 + param1;
         ...
         this.var_2121 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2121) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1879:
               if(this.var_1129 == null)
               {
                  this.var_1129 = new ItemGridCatalogWidget(param1);
                  this.var_34.push(this.var_1129);
               }
               break;
            case CatalogWidgetEnum.const_1848:
               this.var_34.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1743:
               this.var_34.push(new ProductViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1887:
               this.var_34.push(new SongDiskProductViewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_1884:
               this.var_34.push(new SingleViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1797:
               this.var_34.push(new PurchaseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1648:
               this.var_34.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1673:
               this.var_34.push(new ColourGridCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1854:
               this.var_34.push(new TraxPreviewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_1652:
               this.var_34.push(new RedeemItemCodeCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1822:
               this.var_34.push(new SpacesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1668:
               this.var_34.push(new SpacesNewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1599:
               this.var_34.push(new RoomPreviewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1684:
               this.var_34.push(new TrophyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1844:
               this.var_34.push(new PetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1628:
               this.var_34.push(new NewPetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1827:
               this.var_34.push(new TextInputCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1603:
               this.var_34.push(new SpecialInfoWidget(param1));
               break;
            case CatalogWidgetEnum.const_1774:
               this.var_34.push(new RecyclerCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1878:
               this.var_34.push(new RecyclerPrizesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1770:
               this.var_34.push(new BotCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1735:
               this.var_34.push(new MarketPlaceCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1681:
               this.var_34.push(new MarketPlaceOwnItemsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1815:
               this.var_34.push(new ClubGiftWidget(param1,this._catalog.getClubGiftController()));
               break;
            case CatalogWidgetEnum.const_1760:
               this.var_34.push(new ClubBuyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1808:
               this.var_34.push(new ActivityPointDisplayCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1766:
               this.var_34.push(new MadMoneyCatalogWidget(param1));
         }
      }
      ...
      private function removeWidgets(param1:Array) : void
      {
         ...
         for each(_loc2_ in this.var_34)
         {
         ...
         for each(_loc3_ in param1)
         {
            ...
            _loc4_ = this.var_34.indexOf(_loc3_);
            if(_loc4_ >= 0)
            {
               this.var_34.splice(_loc4_,1);
            }
            _loc3_.dispose();
         }
      }
