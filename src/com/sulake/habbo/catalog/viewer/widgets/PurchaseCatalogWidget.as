package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_682:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_781,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2853 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2851 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2852 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_781,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_955:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2853) as IWindowContainer;
               break;
            case Offer.const_1148:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2851) as IWindowContainer;
               break;
            case Offer.const_1101:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2852) as IWindowContainer;
               break;
            default:
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _window.removeChild(this.var_1052);
         ...
         this.var_2057 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_2059 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2957 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_682 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_682 != null)
         {
            if(this.var_1584 != null)
            {
               this.var_682.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1584);
            }
            else
            {
               this.var_682.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1584);
               this.var_682.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onPurchase);
            }
            this.var_682.disable();
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         var _loc3_:String = this.var_90.activityPointType == Purse.const_228 ? "pixels" : "activitypoints";
         ...
         if(this.var_2059 != null)
         {
            ...
            this.var_2059.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_2058 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_90 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_90,page.pageId,this.var_2058);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_90 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_90,page.pageId,this.var_2058,param1.enableBuyAsGift);
         }
      }
   }
}
