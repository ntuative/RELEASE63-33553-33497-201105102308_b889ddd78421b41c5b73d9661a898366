package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_410:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_410 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_410)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_410.numSelectables)
            {
               _loc3_ = this.var_410.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_101[this.var_526]);
      ...
      {
         var _loc2_:int = this.var_632[this.var_526];
         var _loc3_:Offer = this.var_207[this.var_526][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_483.numGridItems)
         {
            _loc2_ = this.var_207[this.var_526][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_632[this.var_526] = (this.var_207[this.var_526] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_632[0];
         var _loc2_:int = this.var_632[1];
         var _loc3_:int = this.var_632[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_387 || _loc1_.pricingModel == Offer.const_421))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_67 || _loc2_.productType == ProductTypeEnum.const_77))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_410.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_410.setSelected(this.var_410.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_483)
            {
               var_483.destroyGridItems();
            }
            page.replaceOffers(this.var_207[this.var_526],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_632[this.var_526];
