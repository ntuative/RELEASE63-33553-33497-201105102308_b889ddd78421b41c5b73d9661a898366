package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1090 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1628 = new Point(this.var_82.x,this.var_82.y);
         ...
         this.var_1629 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1090.text = _loc5_;
         this.var_881.height = this.var_881.textHeight + 5;
         this.var_1090.y = this.var_881.y + this.var_881.height;
         this.var_1090.height = Math.max(130,this.var_1090.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_576:
                  _loc6_ = this.var_1629.clone();
                  if(this.var_486 != null)
                  {
                     this.var_486.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_486,this.var_1354,this.var_1984);
                     ...
                     case ProductTypeEnum.const_223:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_352,AvatarAction.const_562);
                              _loc16_.appendAction(AvatarAction.const_342,_loc8_.productClassId);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            this.var_82.x = this.var_1628.x;
            this.var_82.y = this.var_1628.y;
            if(param3 != null)
            {
