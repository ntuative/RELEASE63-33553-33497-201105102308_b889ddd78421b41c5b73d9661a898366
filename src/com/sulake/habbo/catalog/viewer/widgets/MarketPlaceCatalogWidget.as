package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1935:int = 1;
      
      private const const_1934:int = 2;
      
      private const const_2203:int = 40;
      
      private const const_2202:int = 10;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_508)
         {
            this.var_508.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_508 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_618)
         {
            ...
            this.var_618 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_618)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1934,_loc2_.length);
         if(!this.var_508)
         {
            this.var_508 = new Timer(25);
            this.var_508.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1178 = 0;
         this.populateList();
         this.var_508.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1178 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1178));
            ++this.var_1178;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1935);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_107)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2202;
                  break;
               case "search_input":
                  _loc8_ = this.const_2203;
                  break;
               default:
                  return;
            }
