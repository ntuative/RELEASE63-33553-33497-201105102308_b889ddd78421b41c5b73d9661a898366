   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_961,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_254,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_741,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_213.stop();
            this.var_213.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_213 = null;
         }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_483 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc2_.productContainer.firstProduct.productType == ProductTypeEnum.const_67)
            {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_822 >= 0 && this.var_822 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_822];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_822;
               if(this.var_822 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_576)
         {
            ++this.var_1992;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1992);
         }
      }
