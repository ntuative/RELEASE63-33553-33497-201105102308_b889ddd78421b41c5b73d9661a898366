package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1086:IRoomSession;
      ...
      private var var_391:ICatalogNavigator;
      ...
      private var var_2750:Boolean = true;
      
      private var var_1977:Boolean = false;
      
      private var var_2752:GiftWrappingConfiguration;
      
      private var var_1284:ClubGiftController;
      
      private var var_537:ClubBuyController;
      
      private var var_820:Map;
      
      private var var_1283:Boolean = false;
      
      private var var_1024:IPurchasableOffer;
      
      private var var_1560:IDragAndDropDoneReceiver;
      
      private var var_64:PlacedObjectPurchaseData;
      
      private const const_1054:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         {
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_86,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1611);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_392.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_537.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_157,this.onObjectPlaced);
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_391.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         if(param2 == ProductTypeEnum.const_67)
         {
      ...
      {
         var _loc2_:Array = this.var_820.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_106.getActivityPointsForType(Purse.const_228)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_141,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIcon();
            this.var_392.loadProductData(this);
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_61,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_391 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1054;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_260,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1977 = param1.session.isPrivateRoom;
               this.var_1086 = param1.session;
               if(this.var_92 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1284 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_537 == null)
         {
            this.var_537 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_391.buildCatalogIndex(_loc2_);
         if(this.var_819 && this.var_819 != "")
         {
            this.var_391.openPage(this.var_819);
            this.var_819 = "";
            this.var_1023 = -1;
         }
         else if(this.var_1023 > -1)
         {
            this.var_391.openPageById(this.var_1023,this.var_1978);
            this.var_1023 = -1;
            this.var_1978 = -1;
            this.var_819 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2751 && this._soundManager != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2750 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1217);
         }
         this.var_2750 = false;
         if(this.var_321 != null)
         {
         ...
         if(_loc2_.type == Purse.const_228)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1284.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2752 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_820.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_820.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1086 || !this.var_1086.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1283 && param1.type == RoomEngineObjectEvent.const_157)
         {
            ...
            _loc3_ = this.var_1024.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_64 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1024);
            _loc5_ = this.var_1560;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_312,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_229);
