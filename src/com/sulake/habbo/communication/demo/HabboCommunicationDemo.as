package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_274:ICoreCommunicationManager;
      ...
      private const const_1922:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_604 = param1;
            this.var_54.initConnection(HabboConnectionType.const_262);
         }
      }
      ...
      {
         if(this.var_54 && this.var_132 && this._roomSessionManager && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_132.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_222 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_132.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_132.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_222.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_132.getKey("use.sso.ticket") == "1";
         this.var_604 = this.var_132.getKey("sso.ticket",null);
         this.var_1742 = this.var_132.getKey("flash.client.url","");
         this.var_2397 = this.var_132.getKey("external.variables.txt","");
         if(this.var_222 == null)
         {
            this.var_222 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_54.mode = HabboConnectionType.const_94;
            if(this.var_604)
            {
               this.var_54.initConnection(HabboConnectionType.const_262);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1859);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_54.mode = HabboConnectionType.const_94;
            if(this.var_132.keyExists("local.environment"))
            {
               this.var_54.mode = HabboConnectionType.const_1164;
            }
         }
         this.var_54.initConnection(HabboConnectionType.const_262);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_902);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2399 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_54.mode)
         {
            case HabboConnectionType.const_94:
               _loc6_ = "";
               _loc6_ = this.var_132.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_132.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1420 = _loc4_;
               this.var_222.loadBannerImage(_loc7_ + "?token=" + this.var_1420,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1164:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1685:
               this.var_927 = this.generateRandomHexString(30);
               this.var_498 = new DiffieHellman(new BigInteger(this.var_132.getKey("connection.development.prime"),16),new BigInteger(this.var_132.getKey("connection.development.generator"),16));
               this.var_498.init(this.var_927);
               _loc8_ = this.var_498.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2399);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1742,this.var_2397));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1922,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_604 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_604);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1421)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_222);
         }
         if(param1.type == Event.CLOSE && !this.var_2398)
         {
            _loc2_ = this.var_132.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2398 = true;
         var _loc2_:String = this.var_132.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_132.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1420);
         ...
         while(_loc13_ > 0)
         {
            ...
            _loc15_ = this.var_498.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_927 = _loc14_;
            }
