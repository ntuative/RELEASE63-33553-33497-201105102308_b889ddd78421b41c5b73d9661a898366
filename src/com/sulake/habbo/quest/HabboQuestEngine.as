package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine
   {
      ...
      private var var_1202:QuestController;
      
      private var var_1203:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1202 = new QuestController(this);
         this.var_1203 = new AchievementController(this);
         ...
         registerUpdateReceiver(this.var_1202,3);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_392.events.removeEventListener(BadgeImageReadyEvent.const_118,this.var_1203.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_392.events.addEventListener(BadgeImageReadyEvent.const_118,this.var_1203.onBadgeImageReady);
      }
      ...
      {
         return this.var_1202.questTracker.isVisible();
      }
      ...
      {
         return this.var_181.getKey("questing.enabled","false") == "true";
      }
