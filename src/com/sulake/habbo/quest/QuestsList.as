package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_740 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_740.toggle();
         this.var_1871 = false;
      }
      ...
      private function refresh(param1:Array) : void
      {
         ...
         while(true)
         {
            ...
            {
               this.method_2(true,_loc2_,param1[_loc2_]);
            }
            else
            {
      ...
      private function method_2(param1:Boolean, param2:int, param3:QuestMessageData) : Boolean
      {
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1498;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1871 && !this.var_1870)
            {
               this.var_1871 = false;
