      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.const_871:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1158);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_488:
               ...
               {
                  case RoomSessionQueueEvent.const_1158:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1315) != -1)
                  {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1881) + 1;
                  }
               }
               else
               {
