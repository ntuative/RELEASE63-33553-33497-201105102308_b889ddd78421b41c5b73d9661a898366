package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1387:String = "room_view";
      
      private const const_2180:String = "room_widget";
      
      private var var_84:IWindowContainer;
      
      private var var_2928:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         this.var_2928 = param1.copy();
         this.var_84 = param2.buildFromXML(param1,0) as IWindowContainer;
         if(this.var_84 == null)
         {
            throw new Error("Failed to build layout from XML.");
         }
         this.var_84.width = this.var_84.desktop.width;
         this.var_84.height = this.var_84.desktop.height;
         var _loc4_:IWindowContainer = this.var_84.desktop as IWindowContainer;
         _loc4_.addChildAt(this.var_84,0);
         if(param3)
         {
            if(param3.getKey("friendbar.enabled") == "true")
            {
               this.var_84.findChildByTag("room_widget_infostand").y = this.var_84.findChildByTag("room_widget_infostand").y - 47;
            }
         }
         var _loc6_:int = 0;
         while(_loc6_ < this.var_84.numChildren)
         {
            _loc5_ = this.var_84.getChildAt(_loc6_);
            _loc7_ = false || false;
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         {
            _loc7_ = this.var_84.getChildByName("background_widgets") as IWindowContainer;
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(this.const_2180) == 0)
            {
         ...
         var _loc6_:IWindowContainer = this.var_84.getChildByTag(_loc4_) as IWindowContainer;
         if(_loc6_ == null)
         {
            return false;
         }
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_84.getChildByTag(this.const_1387) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_84.findChildByTag(this.const_1387) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
         ...
         _loc2_.offset(this.var_84.x,this.var_84.y);
         return _loc2_;
      }
