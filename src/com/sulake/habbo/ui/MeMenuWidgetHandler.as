   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_868,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_934,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_479,this.onHelpTutorialEvent);
         ...
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_868,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_934,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_479,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            else
            {
               ...
               _loc2_ = this.var_1713;
            }
         }
         if(this._toolbar != null)
         {
            _loc6_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1214,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_452)
               {
                  ...
                  if(_loc2_.height > const_452 - const_1021)
                  {
                     _loc8_.offset(0,_loc2_.height - const_452 + const_1021);
                  }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1703);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1156);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_752);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_936);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_849);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1823);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_972);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_945);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_984);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_420);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_936:
               ...
               break;
            case RoomWidgetWaveMessage.const_793:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_792:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_694:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_789:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_410:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1110)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_199,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_924:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1124:
                        this._catalog.openCatalogPage(CatalogPageName.const_1871,true);
                        break;
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1752:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1861:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_974:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1307:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1692:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1308:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_752:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_699:
               ...
               if(this._toolbar)
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_61,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
                     {
                        _loc12_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance",HabboClubLevelEnum.const_46);
                     }
            ...
            case RoomWidgetToolbarMessage.const_735:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_933,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_415:
               ...
               if(this._container)
               {
                  ...
                  _loc21_ = 0;
                  if(this._container.sessionDataManager.hasUserRight("fuse_use_club_outfits",HabboClubLevelEnum.const_46))
                  {
                     _loc21_ = 0;
                  }
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_849:
            ...
            case RoomWidgetStoreSettingsMessage.const_972:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_393,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_945:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_393,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_984:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_610));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_420:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_844));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_707));
      }
      ...
      private function onHabboClubSubscriptionChanged(param1:Event = null) : void
      {
         ...
         if(this._inventory != null)
         {
            ...
            if(this._container != null && this._container.sessionDataManager != null)
            {
               _loc2_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance",HabboClubLevelEnum.const_46);
            }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_479:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_579));
         }
      }
