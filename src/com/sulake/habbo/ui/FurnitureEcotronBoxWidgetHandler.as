package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_686,RoomWidgetEcotronBoxOpenMessage.const_892,RoomWidgetEcotronBoxOpenedMessage.const_1821];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_686:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_892:
