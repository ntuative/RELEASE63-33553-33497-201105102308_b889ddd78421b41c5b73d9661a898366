package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,80,"g"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,74,"h"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,416,"o"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,352,"p"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,304,"q"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,336,"r"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,748,"u"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_46,438,"v"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1641 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1641 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1101 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_175.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         if(this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_46))
         {
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_55:
               return true;
            case HabboClubLevelEnum.const_46:
               return this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_46);
            case HabboClubLevelEnum.const_47:
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
