package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1447:int = 267;
      
      private static const const_1445:int = 65;
      
      private static const const_1446:int = -70;
      ...
      private var var_2507:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2507 = new PublicRoomThumbs();
         super();
      ...
      public function refreshAdFooter(param1:IWindowContainer) : void
      {
         ...
         this.method_2(_loc5_,true,1,this._navigator.data.guestRoomSearchResults.ad);
         _loc3_.visible = true;
      ...
      public function method_2(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         Util.hideChildren(param1);
         if(param2)
         {
            param1.id = param4.index;
            if(param4.type == OfficialRoomEntryData.const_1885)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_859 || param2.type == OfficialRoomEntryData.const_755))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1445) : int(const_1447);
      ...
      {
         var _loc4_:String = this.var_2507.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1446) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_275,Tabs.const_407,_loc2_.tag);
         }
