package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2983:IWindowContainer;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_548 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_548.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_548 == null ? 0 : int(this.var_548.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 4)
         {
            return Tabs.const_896;
         }
         return Tabs.const_293;
      }
   }
}
