package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private function method_2(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         this._navigator.officialRoomEntryManager.method_2(_loc4_,param1,param2,param3);
         return false;
      }
   }
}
