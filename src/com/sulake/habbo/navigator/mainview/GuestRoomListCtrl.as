package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_569 = IScrollbarWindow(this.var_175.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         while(true)
         {
            ...
            {
               this.method_2(true,_loc3_,_loc1_[_loc3_]);
            }
            else
            {
               _loc4_ = this.method_2(false,_loc3_,null);
               if(_loc4_)
               {
                  break;
               }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1877,true);
      ...
      private function method_2(param1:Boolean, param2:int, param3:GuestRoomData) : Boolean
      {
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1594.tags[0];
            this.var_1594.color = this.getBgColor(_loc2_);
         }
