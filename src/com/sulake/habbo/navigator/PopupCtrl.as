package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_52 == null)
         {
            this.var_52 = IWindowContainer(this._navigator.getXmlWindow(this.var_1077));
            this.var_52.visible = false;
            this.var_52.setParamFlag(HabboWindowParam.const_41,true);
         ...
         this.var_52.x = _loc2_.x + this.var_2243 + param1.width;
